...
def save_note(subtopic_id, blocks):
    ...
    js_content = f"export const note_biology_5_8_{subtopic_id} = {json.dumps(obj, indent=2)};\n"
    with open(f"src/data/seedNotes/biology/note_5_8_{subtopic_id}.js", "w") as f:
        f.write(js_content)

save_note(15, blocks_15)

print("Saved note 5_8_15")
