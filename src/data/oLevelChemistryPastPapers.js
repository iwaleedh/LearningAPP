...
// All PDFs served locally from public/pastpapers/olevel/chemistry/
...
function gceguideUrl(year, session, fileType, paper, variant) {
    ...
    return `/pastpapers/olevel/chemistry/${year}/0620_${session}${yy}_${fileType}_${paper}${variant}.pdf`;
}

function makeEntry(year, session, monthLabel, paper, variant) {
    const meta = PAPER_META[paper];
    return {
        id: `olevel-chem-${year}-${session}-p${paper}v${variant}`,
        year,
        month: monthLabel,
        unit: `Paper ${paper}`,
        unitName: meta.unitName,
        type: meta.type,
        code: `0620/${paper}${variant}`,
...
export const oLevelChemistryAvailableYears = [
    2025, 2024, 2023, 2022, 2021, 2020, 2019,
    2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010,
];

export const oLevelChemistryAvailableMonths = ['May/June', 'Oct/Nov', 'Feb/March'];
