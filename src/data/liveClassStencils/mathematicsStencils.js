...
const mathematicsStencils = [
  ...
  },
  {
    ...
    category: 'Vectors',
    label: 'Vector Arrow',
    svg: '<svg viewBox="0 0 80 20" xmlns="http://www.w3.org/2000/svg"><line x1="5" y1="10" x2="65" y2="10" stroke="#6366f1" stroke-width="2.5"/><polygon points="75,10 63,4 63,16" fill="#6366f1"/></svg>',
    defaultWidth: 80,
    defaultHeight: 20,
  },
  {
  ...
  },
  {
    ...
    svg: '<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><line x1="0" y1="30" x2="30" y2="30" stroke="#1f2937" stroke-width="2"/><line x1="0" y1="30" x2="0" y2="0" stroke="#1f2937" stroke-width="2"/><rect x="0" y="18" width="12" height="12" fill="none" stroke="#6366f1" stroke-width="1.5"/></svg>',
    defaultWidth: 30,
    defaultHeight: 30,
  },
  {
