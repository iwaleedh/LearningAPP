// O Level Economics Past Papers — Cambridge IGCSE (0455)
// Covers: 2010–2025, May/June + Oct/Nov sessions, Papers 1 & 2
// Feb/March session included from 2019 onwards (variant 2 only)
// All PDFs served locally from public/pastpapers/olevel/economics/

const PAPER_META = {
    1: { unitName: 'Multiple Choice',      type: 'Core', duration: '45 minutes',        totalMarks: 40 },
    2: { unitName: 'Structured Questions', type: 'Core', duration: '2 hours 15 minutes', totalMarks: 90 },
};

function gceguideUrl(year, session, fileType, paper, variant) {
    const yy = String(year).slice(-2);
    return `/pastpapers/olevel/economics/${year}/0455_${session}${yy}_${fileType}_${paper}${variant}.pdf`;
}

function makeEntry(year, session, monthLabel, paper, variant) {
    const meta = PAPER_META[paper];
    return {
        id: `olevel-econ-${year}-${session}-p${paper}v${variant}`,
        year,
        month: monthLabel,
        unit: `Paper ${paper}`,
        unitName: meta.unitName,
        type: meta.type,
        code: `0455/${paper}${variant}`,
...
// 2019–2023: Same as above + Feb/March (m) variant 2 only → 10/year × 5 = 50
...
export const oLevelEconomicsPastPapers = [
    ...entries2010to2018,
    ...entries2019to2023,
    ...entries2024,
    ...entries2025,
...
export const oLevelEconomicsAvailableYears = [
    2025, 2024, 2023, 2022, 2021, 2020, 2019,
    2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010,
];

export const oLevelEconomicsAvailableMonths = ['May/June', 'Oct/Nov', 'Feb/March'];

export const oLevelEconomicsAvailableUnits = [
    { code: 'Paper 1', name: 'Multiple Choice',      type: 'Core' },
    { code: 'Paper 2', name: 'Structured Questions', type: 'Core' },
];
