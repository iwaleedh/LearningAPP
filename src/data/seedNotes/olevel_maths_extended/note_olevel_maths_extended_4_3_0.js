export const note_olevel_maths_extended_4_3_0 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg"><style>text{font-family:system-ui;font-size:13px;fill:#334155;font-weight:600}line{stroke:#3b82f6;stroke-width:2}.tick{stroke:#94a3b8;stroke-width:1}</style><circle cx="150" cy="150" r="120" fill="none" stroke="#3b82f6" stroke-width="2"/><line x1="150" y1="30" x2="150" y2="270"/><line x1="30" y1="150" x2="270" y2="150"/><text x="150" y="22" text-anchor="middle" fill="#3b82f6">N (000°)</text><text x="278" y="155" fill="#3b82f6">E (090°)</text><text x="150" y="290" text-anchor="middle" fill="#3b82f6">S (180°)</text><text x="5" y="155" fill="#3b82f6">W (270°)</text><circle cx="150" cy="150" r="3" fill="#3b82f6"/><path d="M 150 150 L 230 80" stroke="#ef4444" stroke-width="2.5" fill="none" marker-end="url(#arr)"/><defs><marker id="arr" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" fill="#ef4444"/></marker></defs><path d="M 150 130 A 20 20 0 0 1 165 138" fill="none" stroke="#ef4444" stroke-width="2"/><text x="172" y="125" fill="#ef4444">045°</text></svg>',
