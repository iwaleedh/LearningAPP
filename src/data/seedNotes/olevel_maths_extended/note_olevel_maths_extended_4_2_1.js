export const note_olevel_maths_extended_4_2_1 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 350 250" xmlns="http://www.w3.org/2000/svg"><style>text{font-family:system-ui;font-size:13px;fill:#334155}line{stroke:#3b82f6;stroke-width:2.5}.hl{stroke:#10b981;stroke-width:3}</style><line x1="30" y1="70" x2="320" y2="70"/><line x1="30" y1="170" x2="320" y2="170"/><line x1="100" y1="20" x2="220" y2="230"/><text x="330" y="68">&rarr;</text><text x="330" y="168">&rarr;</text><path d="M 148 70 A 15 15 0 0 1 140 56" fill="none" class="hl"/><text x="155" y="58" fill="#10b981" font-weight="600"><em>a</em></text><path d="M 188 170 A 15 15 0 0 1 180 156" fill="none" class="hl"/><text x="195" y="158" fill="#10b981" font-weight="600"><em>a</em></text><text x="175" y="242" text-anchor="middle" font-weight="600" fill="#3b82f6">Corresponding angles (F-shape): equal</text></svg>',
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 350 250" xmlns="http://www.w3.org/2000/svg"><style>text{font-family:system-ui;font-size:13px;fill:#334155}line{stroke:#3b82f6;stroke-width:2.5}.hl{stroke:#f59e0b;stroke-width:3}</style><line x1="30" y1="70" x2="320" y2="70"/><line x1="30" y1="170" x2="320" y2="170"/><line x1="100" y1="20" x2="220" y2="230"/><text x="330" y="68">&rarr;</text><text x="330" y="168">&rarr;</text><path d="M 148 70 A 15 15 0 0 0 140 84" fill="none" class="hl"/><text x="125" y="95" fill="#f59e0b" font-weight="600"><em>b</em></text><path d="M 188 170 A 15 15 0 0 1 180 156" fill="none" class="hl"/><text x="195" y="158" fill="#f59e0b" font-weight="600"><em>b</em></text><text x="175" y="242" text-anchor="middle" font-weight="600" fill="#3b82f6">Alternate angles (Z-shape): equal</text></svg>',
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 350 250" xmlns="http://www.w3.org/2000/svg"><style>text{font-family:system-ui;font-size:13px;fill:#334155}line{stroke:#3b82f6;stroke-width:2.5}.hl{stroke:#ef4444;stroke-width:3}</style><line x1="30" y1="70" x2="320" y2="70"/><line x1="30" y1="170" x2="320" y2="170"/><line x1="100" y1="20" x2="220" y2="230"/><text x="330" y="68">&rarr;</text><text x="330" y="168">&rarr;</text><path d="M 148 70 A 15 15 0 0 0 140 84" fill="none" class="hl"/><text x="125" y="95" fill="#ef4444" font-weight="600"><em>c</em></text><path d="M 188 170 A 15 15 0 0 0 180 184" fill="none" class="hl"/><text x="165" y="195" fill="#ef4444" font-weight="600"><em>d</em></text><text x="175" y="242" text-anchor="middle" font-weight="600" fill="#3b82f6">Co-interior angles (C-shape): <em>c</em> + <em>d</em> = 180°</text></svg>',
