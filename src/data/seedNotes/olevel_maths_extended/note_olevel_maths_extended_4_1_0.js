export const note_olevel_maths_extended_4_1_0 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 600 180" xmlns="http://www.w3.org/2000/svg"><style>text{font-family:system-ui;font-size:12px;fill:#334155}line,polygon{stroke:#6366f1;stroke-width:2;fill:none}.label{font-weight:600;font-size:13px;fill:#6366f1}</style><polygon points="60,20 20,150 100,150"/><text x="60" y="170" text-anchor="middle" class="label">Equilateral</text><text x="55" y="90" text-anchor="middle">60°</text><polygon points="230,20 180,150 280,150"/><line x1="230" y1="20" x2="230" y2="150" stroke="#6366f1" stroke-dasharray="4"/><text x="230" y="170" text-anchor="middle" class="label">Isosceles</text><polygon points="390,40 350,150 470,150"/><text x="410" y="170" text-anchor="middle" class="label">Scalene</text><polygon points="530,150 530,40 590,150"/><rect x="530" y="130" width="15" height="15" fill="none" stroke="#6366f1" stroke-width="1.5"/><text x="555" y="170" text-anchor="middle" class="label">Right-angled</text></svg>',
