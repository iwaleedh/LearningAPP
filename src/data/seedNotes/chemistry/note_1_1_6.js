...
export const note_chemistry_1_1_6 = {
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 195" font-family="Arial,sans-serif"><text x="260" y="15" text-anchor="middle" font-size="12" font-weight="bold" fill="#1f2937">Three Mole Triangles — All Connected via n (moles)</text><polygon points="80,30 15,158 145,158" fill="#2d1b69" stroke="#1d4ed8" stroke-width="2"/><line x1="47" y1="94" x2="113" y2="94" stroke="#1d4ed8" stroke-width="1.5"/><text x="80" y="80" text-anchor="middle" font-size="24" font-weight="bold" fill="#6d28d9">m</text><text x="47" y="132" text-anchor="middle" font-size="20" font-weight="bold" fill="#1d4ed8">n</text><text x="113" y="132" text-anchor="middle" font-size="20" font-weight="bold" fill="#065f46">M</text><text x="80" y="172" text-anchor="middle" font-size="9" fill="#374151">n = m/M</text><text x="80" y="183" text-anchor="middle" font-size="9" fill="#6b7280">mass &#x21C6; moles</text><text x="163" y="91" text-anchor="middle" font-size="18" fill="#9ca3af">&#x21C6;</text><text x="163" y="104" text-anchor="middle" font-size="8" fill="#6b7280">via n</text><polygon points="260,30 195,158 325,158" fill="#1c3a64" stroke="#3b82f6" stroke-width="2"/><line x1="227" y1="94" x2="293" y2="94" stroke="#3b82f6" stroke-width="1.5"/><text x="260" y="80" text-anchor="middle" font-size="24" font-weight="bold" fill="#1e40af">n</text><text x="227" y="132" text-anchor="middle" font-size="20" font-weight="bold" fill="#065f46">c</text><text x="293" y="132" text-anchor="middle" font-size="20" font-weight="bold" fill="#1d4ed8">V</text><text x="260" y="172" text-anchor="middle" font-size="9" fill="#374151">n = c&#xD7;V</text><text x="260" y="183" text-anchor="middle" font-size="9" fill="#6b7280">solutions</text><text x="343" y="91" text-anchor="middle" font-size="18" fill="#9ca3af">&#x21C6;</text><text x="343" y="104" text-anchor="middle" font-size="8" fill="#6b7280">via n</text><polygon points="440,30 375,158 505,158" fill="#0a2e1a" stroke="#10b981" stroke-width="2"/><line x1="407" y1="94" x2="473" y2="94" stroke="#10b981" stroke-width="1.5"/><text x="440" y="80" text-anchor="middle" font-size="24" font-weight="bold" fill="#065f46">V</text><text x="407" y="132" text-anchor="middle" font-size="20" font-weight="bold" fill="#1d4ed8">n</text><text x="473" y="130" text-anchor="middle" font-size="16" font-weight="bold" fill="#1d4ed8">Vm</text><text x="440" y="172" text-anchor="middle" font-size="9" fill="#374151">V = n&#xD7;Vm</text><text x="440" y="183" text-anchor="middle" font-size="9" fill="#6b7280">gas volumes</text></svg>',
