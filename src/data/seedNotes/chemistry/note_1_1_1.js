  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 220" width="720" height="220"><defs><style>.lbl{font-family:Arial,sans-serif;font-size:13px;font-weight:bold;text-anchor:middle}.sub{font-family:Arial,sans-serif;font-size:11px;text-anchor:middle;fill:#374151}.hdr{font-family:Arial,sans-serif;font-size:12px;text-anchor:middle;fill:#6d28d9}</style></defs><rect x="20" y="30" width="130" height="130" rx="8" fill="#2d1b69" stroke="#6d28d9" stroke-width="2"/><text x="85" y="72" class="lbl" fill="#4c1d95">CO₂</text><text x="85" y="92" class="sub">44.0 g mol⁻¹</text><text x="85" y="130" class="hdr">24.0 dm³</text><rect x="190" y="30" width="130" height="130" rx="8" fill="#0a2e1a" stroke="#059669" stroke-width="2"/><text x="255" y="72" class="lbl" fill="#065f46">O₂</text><text x="255" y="92" class="sub">32.0 g mol⁻¹</text><text x="255" y="130" class="hdr">24.0 dm³</text><rect x="360" y="30" width="130" height="130" rx="8" fill="#78350f" stroke="#d97706" stroke-width="2"/><text x="425" y="72" class="lbl" fill="#92400e">N₂</text><text x="425" y="92" class="sub">28.0 g mol⁻¹</text><text x="425" y="130" class="hdr">24.0 dm³</text><rect x="530" y="30" width="130" height="130" rx="8" fill="#3d1212" stroke="#dc2626" stroke-width="2"/><text x="595" y="72" class="lbl" fill="#991b1b">He</text><text x="595" y="92" class="sub">4.0 g mol⁻¹</text><text x="595" y="130" class="hdr">24.0 dm³</text><text x="360" y="185" class="sub" style="font-size:12px;font-weight:bold;fill:#1e40af">All gases: 1 mol occupies 24.0 dm³ at RTP (25°C, 100 kPa)</text><text x="360" y="202" class="sub">Different molar masses, same volume per mole</text></svg>'
      }
    },
    {
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 480" font-family="system-ui,sans-serif"><defs><marker id="mw-arr" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><polygon points="0,0 8,3 0,6" fill="#2d2d72"/></marker></defs><!-- Background panels --><rect x="0" y="0" width="700" height="480" rx="16" fill="rgba(15,15,35,0.0)"/><!-- Title --><text x="350" y="34" text-anchor="middle" font-size="15" font-weight="700" fill="#1e293b" letter-spacing="1">THE MOLE — 4 Routes In and Out</text><!-- Central hub --><circle cx="350" cy="240" r="58" fill="#3b82f6" opacity="0.95"/><text x="350" y="233" text-anchor="middle" font-size="30" font-weight="900" fill="#1e293b">n</text><text x="350" y="256" text-anchor="middle" font-size="11" fill="#2d2d72">moles (mol)</text><!-- Spoke lines: top, right, bottom, left --><line x1="350" y1="182" x2="350" y2="100" stroke="#a5b4fc" stroke-width="2" stroke-dasharray="4,3" marker-end="url(#mw-arr)"/><line x1="408" y1="240" x2="494" y2="240" stroke="#a5b4fc" stroke-width="2" stroke-dasharray="4,3" marker-end="url(#mw-arr)"/><line x1="350" y1="298" x2="350" y2="376" stroke="#a5b4fc" stroke-width="2" stroke-dasharray="4,3" marker-end="url(#mw-arr)"/><line x1="292" y1="240" x2="206" y2="240" stroke="#a5b4fc" stroke-width="2" stroke-dasharray="4,3" marker-end="url(#mw-arr)"/><!-- TOP card: mass --><rect x="252" y="28" width="196" height="68" rx="12" fill="rgba(99,102,241,0.18)" stroke="#60a5fa" stroke-width="1.5"/><text x="350" y="50" text-anchor="middle" font-size="11" fill="#2d2d72" font-weight="600">MASS ROUTE</text><text x="350" y="68" text-anchor="middle" font-size="17" font-weight="800" fill="#1e293b">n = m ÷ M</text><text x="350" y="86" text-anchor="middle" font-size="10" fill="#2d2d72">m in g · M in g mol⁻¹</text><!-- RIGHT card: gas pV=nRT --><rect x="506" y="196" width="176" height="88" rx="12" fill="rgba(16,185,129,0.18)" stroke="#34d399" stroke-width="1.5"/><text x="594" y="218" text-anchor="middle" font-size="11" fill="#065f46" font-weight="600">GAS ROUTE</text><text x="594" y="238" text-anchor="middle" font-size="15" font-weight="800" fill="#1e293b">n = pV ÷ RT</text><text x="594" y="256" text-anchor="middle" font-size="9.5" fill="#065f46">p/Pa · V/m³ · T/K</text><text x="594" y="272" text-anchor="middle" font-size="9.5" fill="#065f46">R = 8.31 J mol⁻¹ K⁻¹</text><!-- BOTTOM card: concentration --><rect x="238" y="384" width="224" height="70" rx="12" fill="rgba(251,146,60,0.18)" stroke="#fb923c" stroke-width="1.5"/><text x="350" y="406" text-anchor="middle" font-size="11" fill="#532407" font-weight="600">SOLUTION ROUTE</text><text x="350" y="424" text-anchor="middle" font-size="17" font-weight="800" fill="#1e293b">n = c × V</text><text x="350" y="442" text-anchor="middle" font-size="10" fill="#532407">c in mol dm⁻³ · V in dm³</text><!-- LEFT card: particles --><rect x="18" y="192" width="176" height="96" rx="12" fill="rgba(244,114,182,0.18)" stroke="#f472b6" stroke-width="1.5"/><text x="106" y="215" text-anchor="middle" font-size="11" fill="#4a1040" font-weight="600">PARTICLES ROUTE</text><text x="106" y="237" text-anchor="middle" font-size="15" font-weight="800" fill="#1e293b">n = N ÷ L</text><text x="106" y="257" text-anchor="middle" font-size="9.5" fill="#4a1040">N = number of particles</text><text x="106" y="272" text-anchor="middle" font-size="9.5" fill="#4a1040">L = 6.02 × 10²³ mol⁻¹</text><!-- Corner labels --><text x="350" y="466" text-anchor="middle" font-size="10" fill="#3b82f6">All 4 routes connect through n — moles is the universal currency of chemistry</text></svg>',
        caption: 'The Mole Web — 4 routes into/out of moles. Every stoichiometry calculation passes through n. Master these 4 equations and you can solve any quantitative chemistry problem.'
      },
      terms: []
    }
  ],
