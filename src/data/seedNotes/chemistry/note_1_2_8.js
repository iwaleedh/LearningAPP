...
export const note_chemistry_1_2_8 = {
  ...
  <!-- Si: 1414°C → y = 56 -->
  <circle cx="255" cy="56" r="5" fill="#1d4ed8"/>
  ...
  <circle cx="180" cy="220" r="5" fill="#1d4ed8"/>
