...
export const note_chemistry_1_1_0 = {
  blocks: [
    ...
    {
      id: 'svg-particle-models',
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 220" width="800" height="220"><defs><style>.txt { fill: #1f2937; font-size: 12px; } .atom-circle { fill: #f3f4f6; stroke: #6b7280; stroke-width: 1.5; } .atom-text { fill: #111827; font-family: monospace; font-size: 14px; font-weight: bold; } .bond { stroke: #111827; stroke-width: 2; } .label { fill: #1e40af; font-weight: bold; font-size: 13px; }</style></defs><!-- Atom --><g transform="translate(100, 80)"><circle cx="0" cy="0" r="28" class="atom-circle"/><text x="0" y="4" text-anchor="middle" class="atom-text">Au</text></g><text x="100" y="130" text-anchor="middle" class="label">Atom</text><text x="100" y="148" text-anchor="middle" class="txt">Smallest particle</text><text x="100" y="163" text-anchor="middle" class="txt">of an element</text><!-- Element --><g transform="translate(325, 80)"><circle cx="-30" cy="0" r="28" class="atom-circle"/><circle cx="30" cy="0" r="28" class="atom-circle"/><text x="-30" y="4" text-anchor="middle" class="atom-text">Cl</text><text x="30" y="4" text-anchor="middle" class="atom-text">Cl</text><line x1="-2" y1="0" x2="2" y2="0" class="bond"/></g><text x="325" y="130" text-anchor="middle" class="label">Element</text><text x="325" y="148" text-anchor="middle" class="txt">Same atoms bonded</text><text x="325" y="163" text-anchor="middle" class="txt">(e.g. Cl₂, O₂)</text><!-- Molecule --><g transform="translate(550, 80)"><circle cx="-32" cy="0" r="28" class="atom-circle"/><circle cx="32" cy="0" r="28" class="atom-circle"/><text x="-32" y="4" text-anchor="middle" class="atom-text">H</text><text x="32" y="4" text-anchor="middle" class="atom-text">H</text><line x1="-4" y1="0" x2="4" y2="0" class="bond"/></g><text x="550" y="130" text-anchor="middle" class="label">Molecule</text><text x="550" y="148" text-anchor="middle" class="txt">2+ atoms bonded</text><text x="550" y="163" text-anchor="middle" class="txt">(same element)</text><!-- Compound --><g transform="translate(700, 80)"><circle cx="-32" cy="0" r="28" class="atom-circle"/><circle cx="32" cy="0" r="28" class="atom-circle"/><text x="-32" y="4" text-anchor="middle" class="atom-text">H</text><text x="32" y="4" text-anchor="middle" class="atom-text">O</text><line x1="-4" y1="0" x2="4" y2="0" class="bond"/></g><text x="700" y="130" text-anchor="middle" class="label">Compound</text><text x="700" y="148" text-anchor="middle" class="txt">Different elements</text><text x="700" y="163" text-anchor="middle" class="txt">bonded (e.g. H₂O)</text></svg>',
        caption: 'Visual representation of atom, element, molecule, and compound'
      }
    },
    {
      id: 'svg-mono-di-poly',
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 220" width="800" height="220"><defs><style>.txt { fill: #1f2937; font-size: 12px; } .atom-circle { fill: #f3f4f6; stroke: #6b7280; stroke-width: 1.5; } .atom-text { fill: #111827; font-family: monospace; font-size: 14px; font-weight: bold; } .bond { stroke: #111827; stroke-width: 2; } .label { fill: #1e40af; font-weight: bold; font-size: 13px; }</style></defs><!-- Monatomic --><g transform="translate(150, 80)"><circle cx="0" cy="0" r="32" class="atom-circle"/><text x="0" y="4" text-anchor="middle" class="atom-text">He</text></g><text x="150" y="135" text-anchor="middle" class="label">Monatomic</text><text x="150" y="153" text-anchor="middle" class="txt">Single atom</text><text x="150" y="168" text-anchor="middle" class="txt">(He, Ne, Ar)</text><!-- Diatomic --><g transform="translate(400, 80)"><circle cx="-35" cy="0" r="28" class="atom-circle"/><circle cx="35" cy="0" r="28" class="atom-circle"/><text x="-35" y="4" text-anchor="middle" class="atom-text">Cl</text><text x="35" y="4" text-anchor="middle" class="atom-text">Cl</text><line x1="-7" y1="0" x2="7" y2="0" class="bond"/></g><text x="400" y="135" text-anchor="middle" class="label">Diatomic</text><text x="400" y="153" text-anchor="middle" class="txt">Two atoms bonded</text><text x="400" y="168" text-anchor="middle" class="txt">(Cl₂, O₂, N₂)</text><!-- Polyatomic --><g transform="translate(650, 80)"><circle cx="0" cy="0" r="28" class="atom-circle"/><circle cx="0" cy="-45" r="22" class="atom-circle"/><circle cx="0" cy="45" r="22" class="atom-circle"/><circle cx="-40" cy="0" r="22" class="atom-circle"/><circle cx="40" cy="0" r="22" class="atom-circle"/><text x="0" y="4" text-anchor="middle" class="atom-text">C</text><text x="0" y="-41" text-anchor="middle" class="atom-text">H</text><text x="0" y="49" text-anchor="middle" class="atom-text">H</text><text x="-40" y="4" text-anchor="middle" class="atom-text">H</text><text x="40" y="4" text-anchor="middle" class="atom-text">H</text><line x1="0" y1="-17" x2="0" y2="-23" class="bond"/><line x1="0" y1="17" x2="0" y2="23" class="bond"/><line x1="-12" y1="0" x2="-18" y2="0" class="bond"/><line x1="12" y1="0" x2="18" y2="0" class="bond"/></g><text x="650" y="135" text-anchor="middle" class="label">Polyatomic</text><text x="650" y="153" text-anchor="middle" class="txt">3+ atoms bonded</text><text x="650" y="168" text-anchor="middle" class="txt">(CH₄, P₄, S₈)</text></svg>',
        caption: 'Examples of monatomic, diatomic, and polyatomic substances'
      }
    },
    {
      id: 'h-poly',
