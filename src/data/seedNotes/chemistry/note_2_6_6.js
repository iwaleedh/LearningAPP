    ...
    blocks: [
        ...
        },
        {
            ...
            data: {
                ...
                svg: '<svg viewBox="0 0 490 310" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11"><defs><marker id="e-up" markerWidth="9" markerHeight="7" refX="8" refY="3.5" orient="auto"><polygon points="0,0 9,3.5 0,7" fill="#1d4ed8"/></marker><marker id="e-dn" markerWidth="9" markerHeight="7" refX="8" refY="3.5" orient="auto"><polygon points="0,0 9,3.5 0,7" fill="#15803d"/></marker><marker id="e-dh" markerWidth="9" markerHeight="7" refX="8" refY="3.5" orient="auto"><polygon points="0,0 9,3.5 0,7" fill="#3b82f6"/></marker></defs><text x="245" y="16" text-anchor="middle" font-weight="bold" font-size="12" fill="#374151">Bond Enthalpy Energy Cycle (Exothermic Example)</text><!-- y-axis --><line x1="32" y1="275" x2="32" y2="28" stroke="#374151" stroke-width="1.5"/><polygon points="27,28 37,28 32,18" fill="#374151"/><text x="20" y="155" text-anchor="middle" fill="#374151" font-size="11" transform="rotate(-90,20,155)">Enthalpy</text><!-- Atoms level - highest, purple --><line x1="160" y1="66" x2="330" y2="66" stroke="#1d4ed8" stroke-width="3"/><rect x="155" y="51" width="180" height="28" rx="4" fill="#2d1b69" stroke="#d8b4fe" stroke-width="1.5" opacity="0.9"/><text x="245" y="68" text-anchor="middle" fill="#1d4ed8" font-weight="bold" font-size="11">Separated gaseous atoms</text><!-- Reactants level - middle left, blue --><line x1="52" y1="162" x2="178" y2="162" stroke="#1d4ed8" stroke-width="3"/><rect x="44" y="148" width="143" height="28" rx="4" fill="#1c3a64" stroke="#93c5fd" stroke-width="1.5" opacity="0.9"/><text x="115" y="166" text-anchor="middle" fill="#1d4ed8" font-weight="bold" font-size="11">Reactants (g)</text><!-- Products level - lower right, green --><line x1="312" y1="244" x2="458" y2="244" stroke="#15803d" stroke-width="3"/><rect x="304" y="230" width="162" height="28" rx="4" fill="#0a2e1a" stroke="#86efac" stroke-width="1.5" opacity="0.9"/><text x="385" y="248" text-anchor="middle" fill="#15803d" font-weight="bold" font-size="11">Products (g)</text><!-- Arrow: reactants to atoms (bonds broken, up, purple) --><line x1="170" y1="159" x2="212" y2="72" stroke="#1d4ed8" stroke-width="2.5" marker-end="url(#e-up)"/><rect x="65" y="96" width="100" height="30" rx="3" fill="#1e293b" opacity="0.92"/><text x="115" y="110" text-anchor="middle" fill="#1d4ed8" font-size="10" font-weight="bold">Σ bonds broken</text><text x="115" y="122" text-anchor="middle" fill="#1d4ed8" font-size="10">(+, endothermic)</text><!-- Arrow: atoms to products (bonds made, down, green) --><line x1="278" y1="72" x2="360" y2="237" stroke="#15803d" stroke-width="2.5" marker-end="url(#e-dn)"/><rect x="303" y="122" width="100" height="30" rx="3" fill="#1e293b" opacity="0.92"/><text x="353" y="136" text-anchor="middle" fill="#15803d" font-size="10" font-weight="bold">Σ bonds made</text><text x="353" y="148" text-anchor="middle" fill="#15803d" font-size="10">(−, exothermic)</text><!-- Arrow: reactants to products (net ΔH, dashed indigo) --><line x1="158" y1="165" x2="312" y2="241" stroke="#3b82f6" stroke-width="2" stroke-dasharray="8,4" marker-end="url(#e-dh)"/><rect x="165" y="212" width="156" height="30" rx="3" fill="#1c3a64" opacity="0.96" stroke="#a5b4fc"/><text x="243" y="226" text-anchor="middle" fill="#3b82f6" font-size="10" font-weight="bold">ΔH = Σ(broken) − Σ(made)</text><text x="243" y="239" text-anchor="middle" fill="#3b82f6" font-size="10">(negative = exothermic)</text><!-- footnote --><text x="245" y="298" text-anchor="middle" fill="#6b7280" font-size="9" font-style="italic">All species must be gaseous for bond enthalpy values to be valid (state symbol (g) required).</text></svg>'
            },
            terms: []
        },
