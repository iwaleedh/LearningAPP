    ...
    blocks: [
        ...
        },
        {
            ...
            data: {
                ...
                svg: '<svg viewBox="0 0 500 135" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10"><rect x="5" y="20" width="140" height="40" rx="5" fill="#2d2f72" stroke="#6366f1"/><text x="75" y="36" text-anchor="middle" fill="#3730a3">½X₂(g) → X(g)</text><text x="75" y="50" text-anchor="middle" fill="#3730a3">Atomisation (+ve)</text><text x="150" y="43" text-anchor="middle" fill="#555" font-size="13">→</text><rect x="160" y="20" width="145" height="40" rx="5" fill="#0a2e1a" stroke="#22c55e"/><text x="232" y="36" text-anchor="middle" fill="#166534">X(g) + e⁻ → X⁻(g)</text><text x="232" y="50" text-anchor="middle" fill="#166534">Electron affinity (−ve)</text><text x="310" y="43" text-anchor="middle" fill="#555" font-size="13">→</text><rect x="318" y="20" width="140" height="40" rx="5" fill="#78350f" stroke="#f59e0b"/><text x="388" y="36" text-anchor="middle" fill="#92400e">X⁻(g) → X⁻(aq)</text><text x="388" y="50" text-anchor="middle" fill="#92400e">Hydration enthalpy (−ve)</text><text x="250" y="80" text-anchor="middle" fill="#1e293b" font-weight="bold" font-size="11">Overall = Atomisation + EA + Hydration of X⁻</text><text x="250" y="97" text-anchor="middle" fill="#6366f1">More negative overall energy = stronger oxidising agent</text><text x="250" y="114" text-anchor="middle" fill="#555">Key driver for Cl→Br→I trend: hydration enthalpy of X⁻ (falls as ion gets larger)</text></svg>'
            },
            terms: []
        },
        {
        ...
        },
        {
            ...
            data: {
                ...
                svg: '<svg viewBox="0 0 400 175" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><text x="200" y="15" text-anchor="middle" font-size="12" fill="#1e293b" font-weight="bold">Oxidising Power — Overall ΔH (kJ mol⁻¹)</text><line x1="60" y1="25" x2="60" y2="155" stroke="#94a3b8" stroke-width="1.5"/><line x1="60" y1="155" x2="385" y2="155" stroke="#94a3b8" stroke-width="1.5"/><rect x="65" y="35" width="290" height="22" fill="#6366f1" rx="3"/><text x="360" y="50" font-size="10" fill="#3730a3">F₂  −755</text><rect x="65" y="65" width="228" height="22" fill="#14532d" rx="3"/><text x="298" y="80" font-size="10" fill="#166534">Cl₂  −592</text><rect x="65" y="95" width="211" height="22" fill="#78350f" rx="3"/><text x="281" y="110" font-size="10" fill="#92400e">Br₂  −547</text><rect x="65" y="125" width="185" height="22" fill="#ef4444" rx="3"/><text x="255" y="140" font-size="10" fill="#991b1b">I₂  −481</text><text x="200" y="168" text-anchor="middle" font-size="10" fill="#64748b">← More negative = stronger oxidising agent</text></svg>'
            },
            terms: []
        },
        {
