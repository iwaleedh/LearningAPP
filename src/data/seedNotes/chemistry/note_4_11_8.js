...
export const note_chemistry_4_11_8 = {
  ...
  <!-- Box 1 -->
  <rect x='10' y='35' width='105' height='44' rx='6' fill='#1e3a8a' stroke='#1d4ed8' stroke-width='1.5'/>
  ...
  <!-- Box 2 -->
  <rect x='138' y='35' width='105' height='44' rx='6' fill='#44370a' stroke='#ca8a04' stroke-width='1.5'/>
  ...
  <!-- Box 3 -->
  <rect x='266' y='35' width='113' height='44' rx='6' fill='#0a2e1a' stroke='#16a34a' stroke-width='1.5'/>
  ...
  <!-- Box 4 -->
  <rect x='402' y='35' width='128' height='44' rx='6' fill='#2d1b69' stroke='#7c3aed' stroke-width='1.5'/>
  ...
  <g transform='translate(10,25)'>
    <rect x='0' y='0' width='150' height='150' rx='6' fill='#0a2e1a' stroke='#16a34a' stroke-width='1.2'/>
  ...
  <g transform='translate(185,25)'>
    <rect x='0' y='0' width='150' height='150' rx='6' fill='#1c3a64' stroke='#2563eb' stroke-width='1.2'/>
  ...
  <g transform='translate(360,25)'>
    <rect x='0' y='0' width='150' height='150' rx='6' fill='#532407' stroke='#ea580c' stroke-width='1.2'/>
  ...
  <text x='115' y='170' font-size='10' fill='#374151'>Eₐ = −gradient × 8.314</text>
    ...
    {
      id: 'svg-kinetics-master',
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 450" font-family="system-ui,sans-serif"><text x="350" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#1e293b" letter-spacing="1">KINETICS MASTER MAP</text><!-- LEFT: Rate Orders --><rect x="10" y="32" width="330" height="408" rx="10" fill="rgba(52,211,153,0.08)" stroke="#34d399" stroke-width="1.5"/><text x="175" y="52" text-anchor="middle" font-size="11" fill="#34d399" font-weight="700">RATE ORDERS — IDENTIFICATION</text><text x="175" y="66" text-anchor="middle" font-size="9" fill="#065f46">rate = k[A]^m[B]^n   overall order = m+n</text><!-- 0th order row --><rect x="22" y="74" width="306" height="84" rx="8" fill="rgba(96,165,250,0.15)" stroke="#60a5fa" stroke-width="1"/><text x="175" y="92" text-anchor="middle" font-size="10" fill="#60a5fa" font-weight="700">0th ORDER</text><text x="30" y="109" font-size="8.5" fill="#1e3a8a">Rate independent of [A]: rate = k</text><text x="30" y="123" font-size="8.5" fill="#1e3a8a">Conc–time graph: STRAIGHT LINE (negative slope)</text><text x="30" y="137" font-size="8.5" fill="#1e3a8a">Rate–conc graph: horizontal line</text><text x="30" y="149" font-size="8.5" fill="#1250a0">Units of k: mol dm⁻³ s⁻¹</text><!-- 1st order row --><rect x="22" y="164" width="306" height="98" rx="8" fill="rgba(251,146,60,0.15)" stroke="#fb923c" stroke-width="1"/><text x="175" y="182" text-anchor="middle" font-size="10" fill="#fb923c" font-weight="700">1st ORDER  (most common)</text><text x="30" y="199" font-size="8.5" fill="#532407">Rate proportional to [A]: rate = k[A]</text><text x="30" y="213" font-size="8.5" fill="#532407">Conc–time graph: EXPONENTIAL DECAY</text><text x="30" y="227" font-size="8.5" fill="#532407">Half-life CONSTANT (t₁₂ = ln2/k)</text><text x="30" y="241" font-size="8.5" fill="#532407">Rate–conc graph: straight line through origin</text><text x="30" y="253" font-size="8.5" fill="#78350f">Units of k: s⁻¹</text><!-- 2nd order row --><rect x="22" y="268" width="306" height="98" rx="8" fill="rgba(244,114,182,0.15)" stroke="#f472b6" stroke-width="1"/><text x="175" y="286" text-anchor="middle" font-size="10" fill="#f472b6" font-weight="700">2nd ORDER</text><text x="30" y="303" font-size="8.5" fill="#4a1040">Rate ∝ [A]²: rate = k[A]²</text><text x="30" y="317" font-size="8.5" fill="#4a1040">Conc–time graph: curve that decays slower than exp</text><text x="30" y="331" font-size="8.5" fill="#4a1040">Half-life INCREASES as reaction proceeds</text><text x="30" y="345" font-size="8.5" fill="#4a1040">1/[A] vs time gives straight line — diagnostic!</text><text x="30" y="357" font-size="8.5" fill="#f472b6">Units of k: dm³ mol⁻¹ s⁻¹</text><!-- Key tip: deducing order --><rect x="22" y="374" width="306" height="56" rx="8" fill="rgba(99,102,241,0.15)" stroke="#818cf8" stroke-width="1"/><text x="175" y="392" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">DEDUCING ORDER FROM DATA</text><text x="30" y="407" font-size="8.5" fill="#2d2d72">Double [A], rate doubles → 1st order in A</text><text x="30" y="421" font-size="8.5" fill="#2d2d72">Double [A], rate quadruples → 2nd order in A</text><!-- RIGHT: Arrhenius --><rect x="360" y="32" width="330" height="408" rx="10" fill="rgba(239,68,68,0.08)" stroke="#ef4444" stroke-width="1.5"/><text x="525" y="52" text-anchor="middle" font-size="11" fill="#ef4444" font-weight="700">ARRHENIUS &amp; ACTIVATION ENERGY</text><rect x="374" y="62" width="302" height="50" rx="8" fill="rgba(239,68,68,0.2)" stroke="#ef4444" stroke-width="1.5"/><text x="525" y="80" text-anchor="middle" font-size="12" font-weight="900" fill="#1e293b">k = A × e^(−Ea/RT)</text><text x="525" y="100" text-anchor="middle" font-size="8.5" fill="#7f1d1d">k = rate const | A = pre-exponential factor | Ea = activation energy | R = 8.31 | T in Kelvin</text><!-- Log form --><rect x="374" y="118" width="302" height="40" rx="8" fill="rgba(239,68,68,0.12)" stroke="#ef4444" stroke-width="1"/><text x="525" y="134" text-anchor="middle" font-size="10" fill="#ef4444" font-weight="700">Linearised: ln k = ln A − Ea/RT</text><text x="525" y="150" text-anchor="middle" font-size="8.5" fill="#7f1d1d">Plot ln k vs 1/T → slope = −Ea/R → Ea = −slope × R</text><!-- What affects rate? --><rect x="374" y="166" width="302" height="120" rx="8" fill="rgba(239,68,68,0.1)" stroke="#ef4444" stroke-width="1"/><text x="525" y="184" text-anchor="middle" font-size="10" fill="#ef4444" font-weight="700">FACTORS AFFECTING RATE</text><text x="380" y="202" font-size="9" fill="#1e293b">↑ Temperature → more molecules exceed Ea → k↑</text><text x="380" y="218" font-size="9" fill="#7f1d1d">Even 10°C rise roughly doubles rate</text><text x="380" y="234" font-size="9" fill="#1e293b">Catalyst → lower Ea → more molecules exceed Ea</text><text x="380" y="250" font-size="9" fill="#7f1d1d">Catalyst does NOT change ΔH or K</text><text x="380" y="266" font-size="9" fill="#1e293b">↑ Concentration → more collisions → rate↑</text><text x="380" y="282" font-size="9" fill="#7f1d1d">Surface area, pressure (gases) also increase collision freq</text><!-- Mechanism and rate --><rect x="374" y="294" width="302" height="100" rx="8" fill="rgba(251,146,60,0.15)" stroke="#fb923c" stroke-width="1"/><text x="525" y="312" text-anchor="middle" font-size="10" fill="#fb923c" font-weight="700">RATE EQUATION AND MECHANISM</text><text x="380" y="330" font-size="8.5" fill="#532407">Rate equation only includes species in the</text><text x="380" y="345" font-size="8.5" fill="#532407">RATE-DETERMINING STEP (RDS)</text><text x="380" y="360" font-size="8.5" fill="#532407">SN1: rate = k[RX] → unimolecular RDS</text><text x="380" y="375" font-size="8.5" fill="#532407">SN2: rate = k[RX][Nu] → bimolecular RDS</text><text x="380" y="386" font-size="8.5" fill="#78350f">Intermediates from earlier steps can appear in rate eq.</text><!-- Units of k --><rect x="374" y="404" width="302" height="28" rx="8" fill="rgba(99,102,241,0.15)" stroke="#818cf8" stroke-width="1"/><text x="525" y="418" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">UNITS OF k: always work out from rate = k×[A]^n×[B]^m</text><text x="525" y="432" text-anchor="middle" font-size="8.5" fill="#2d2d72">1st: s⁻¹ | 2nd: dm³ mol⁻¹ s⁻¹ | 0th: mol dm⁻³ s⁻¹</text></svg>',
