    ...
    blocks: [
        ...
        },
        {
            ...
            data: {
                ...
                svg: '<svg viewBox="0 0 500 265" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><defs><marker id="r-arr" markerWidth="8" markerHeight="7" refX="7" refY="3.5" orient="auto"><polygon points="0,0 8,3.5 0,7" fill="#2563eb"/></marker></defs><text x="245" y="17" text-anchor="middle" font-weight="bold" font-size="13" fill="#374151">C–X Mean Bond Enthalpies and Reactivity Trend</text><line x1="88" y1="27" x2="88" y2="208" stroke="#374151" stroke-width="1.5"/><rect x="90" y="34" width="305" height="33" rx="3" fill="#dc2626" opacity="0.82"/><text x="83" y="55" text-anchor="end" fill="#374151" font-size="12" font-weight="bold">C–F</text><text x="243" y="55" text-anchor="middle" fill="#1e293b" font-size="11" font-weight="bold">467 kJ mol⁻¹</text><rect x="90" y="76" width="222" height="33" rx="3" fill="#ea580c" opacity="0.82"/><text x="83" y="97" text-anchor="end" fill="#374151" font-size="12" font-weight="bold">C–Cl</text><text x="201" y="97" text-anchor="middle" fill="#1e293b" font-size="11" font-weight="bold">340 kJ mol⁻¹</text><rect x="90" y="118" width="183" height="33" rx="3" fill="#d97706" opacity="0.82"/><text x="83" y="139" text-anchor="end" fill="#374151" font-size="12" font-weight="bold">C–Br</text><text x="182" y="139" text-anchor="middle" fill="#1e293b" font-size="11" font-weight="bold">280 kJ mol⁻¹</text><rect x="90" y="160" width="149" height="33" rx="3" fill="#16a34a" opacity="0.82"/><text x="83" y="181" text-anchor="end" fill="#374151" font-size="12" font-weight="bold">C–I</text><text x="165" y="181" text-anchor="middle" fill="#1e293b" font-size="11" font-weight="bold">228 kJ mol⁻¹</text><line x1="88" y1="208" x2="400" y2="208" stroke="#9ca3af" stroke-width="1"/><text x="244" y="222" text-anchor="middle" fill="#6b7280" font-size="10">Mean bond enthalpy / kJ mol⁻¹</text><text x="455" y="36" text-anchor="middle" fill="#6b7280" font-size="9">Least</text><text x="455" y="47" text-anchor="middle" fill="#6b7280" font-size="9">reactive</text><line x1="455" y1="54" x2="455" y2="182" stroke="#2563eb" stroke-width="2.5" marker-end="url(#r-arr)"/><text x="455" y="198" text-anchor="middle" fill="#2563eb" font-size="9" font-weight="bold">Most</text><text x="455" y="208" text-anchor="middle" fill="#2563eb" font-size="9" font-weight="bold">reactive</text><text x="10" y="250" fill="#6b7280" font-size="9" font-style="italic">C–I bond weakest → lowest activation energy → fastest nucleophilic substitution.</text><text x="10" y="260" fill="#6b7280" font-size="9" font-style="italic">C–F bond strongest → highest activation energy → practically unreactive.</text></svg>'
            },
            terms: []
        },
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 430" font-family="system-ui,sans-serif"><defs><marker id="hm-arr" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto"><polygon points="0,0 7,3.5 0,7" fill="#2d2d72"/></marker></defs><text x="350" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#1e293b" letter-spacing="1">HESS CYCLE — 3 ROUTES TO ΔH°reaction</text><!-- Reactants box --><rect x="20" y="50" width="200" height="60" rx="10" fill="rgba(244,114,182,0.2)" stroke="#f472b6" stroke-width="2"/><text x="120" y="76" text-anchor="middle" font-size="12" font-weight="800" fill="#1e293b">REACTANTS</text><text x="120" y="96" text-anchor="middle" font-size="9" fill="#4a1040">e.g. C(s) + H₂(g)</text><!-- Products box --><rect x="480" y="50" width="200" height="60" rx="10" fill="rgba(96,165,250,0.2)" stroke="#60a5fa" stroke-width="2"/><text x="580" y="76" text-anchor="middle" font-size="12" font-weight="800" fill="#1e293b">PRODUCTS</text><text x="580" y="96" text-anchor="middle" font-size="9" fill="#1e3a8a">e.g. CH₄(g)</text><!-- Direct arrow (Route 1) --><line x1="220" y1="80" x2="480" y2="80" stroke="#a5b4fc" stroke-width="2" stroke-dasharray="6,3" marker-end="url(#hm-arr)"/><rect x="280" y="58" width="140" height="38" rx="8" fill="rgba(99,102,241,0.3)" stroke="#60a5fa" stroke-width="1.5"/><text x="350" y="74" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">ROUTE 1 (Direct)</text><text x="350" y="87" text-anchor="middle" font-size="11" font-weight="800" fill="#1e293b">ΔH°rxn  (target)</text><!-- Elements reference level --><rect x="230" y="198" width="240" height="56" rx="10" fill="rgba(52,211,153,0.2)" stroke="#34d399" stroke-width="2"/><text x="350" y="220" text-anchor="middle" font-size="11" font-weight="700" fill="#34d399">ELEMENTS IN STD STATE</text><text x="350" y="236" text-anchor="middle" font-size="9" fill="#065f46">reference level for ΔH°f</text><!-- Formation arrows --><line x1="350" y1="198" x2="120" y2="110" stroke="#34d399" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#hm-arr)"/><text x="200" y="158" text-anchor="middle" font-size="8.5" fill="#34d399">−ΣΔH°f(reactants)</text><line x1="350" y1="198" x2="580" y2="110" stroke="#34d399" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#hm-arr)"/><text x="500" y="158" text-anchor="middle" font-size="8.5" fill="#34d399">+ΣΔH°f(products)</text><rect x="192" y="252" width="316" height="52" rx="8" fill="rgba(52,211,153,0.12)" stroke="#34d399" stroke-width="1"/><text x="350" y="272" text-anchor="middle" font-size="10" fill="#34d399" font-weight="700">ROUTE 2: Formation Cycle</text><text x="350" y="288" text-anchor="middle" font-size="10" font-weight="800" fill="#1e293b">ΔH°rxn = ΣΔH°f(prod) − ΣΔH°f(react)</text><!-- Combustion reference level --><rect x="230" y="340" width="240" height="50" rx="10" fill="rgba(239,68,68,0.2)" stroke="#ef4444" stroke-width="2"/><text x="350" y="360" text-anchor="middle" font-size="11" font-weight="700" fill="#ef4444">COMBUSTION PRODUCTS</text><text x="350" y="376" text-anchor="middle" font-size="9" fill="#7f1d1d">CO₂(g) + H₂O(l) (common level)</text><!-- Combustion arrows --><line x1="120" y1="110" x2="270" y2="340" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#hm-arr)"/><text x="148" y="248" text-anchor="middle" font-size="8.5" fill="#ef4444" transform="rotate(-55 148 248)">+ΔH°c(reactants)</text><line x1="580" y1="110" x2="430" y2="340" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#hm-arr)"/><text x="543" y="230" text-anchor="middle" font-size="8.5" fill="#ef4444">−ΔH°c(products)</text><rect x="192" y="400" width="316" height="26" rx="8" fill="rgba(239,68,68,0.12)" stroke="#ef4444" stroke-width="1"/><text x="350" y="418" text-anchor="middle" font-size="10" font-weight="800" fill="#1e293b">ΔH°rxn = ΣΔH°c(react) − ΣΔH°c(prod)</text><!-- Bond enthalpy note --><rect x="10" y="310" width="170" height="76" rx="8" fill="rgba(251,146,60,0.15)" stroke="#fb923c" stroke-width="1"/><text x="95" y="328" text-anchor="middle" font-size="9" fill="#fb923c" font-weight="700">ROUTE 3: Bond Enthalpies</text><text x="95" y="345" text-anchor="middle" font-size="8.5" fill="#532407">ΔH = ΣE(broken) – ΣE(formed)</text><text x="95" y="361" text-anchor="middle" font-size="8" fill="#532407">breaking bonds: endothermic (+)</text><text x="95" y="376" text-anchor="middle" font-size="8" fill="#532407">forming bonds: exothermic (−)</text></svg>',
                caption: 'Hess Cycle — 3 routes to find ΔH°reaction. Route 2 (formation cycle): ΣΔH°f(products) − ΣΔH°f(reactants). Route 3 (combustion): ΣΔH°c(reactants) − ΣΔH°c(products). Bond enthalpy route works for gases only and gives approximate values.'
            },
            terms: []
        }
    ],
