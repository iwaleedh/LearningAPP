  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        svg: '<svg viewBox="0 0 500 360" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="12"><rect x="140" y="60" width="220" height="260" rx="8" fill="#f0f4ff" stroke="#6366f1" stroke-width="2.5"/><rect x="130" y="48" width="240" height="16" rx="4" fill="#6366f1" opacity="0.8"/><text x="250" y="60" text-anchor="middle" fill="white" font-weight="bold" font-size="11">Lid (prevents evaporation)</text><rect x="148" y="265" width="204" height="47" rx="4" fill="#bfdbfe" opacity="0.7"/><text x="250" y="295" text-anchor="middle" fill="#1e40af" font-weight="bold">Solvent (mobile phase)</text><rect x="226" y="75" width="48" height="230" rx="3" fill="white" stroke="#9ca3af" stroke-width="1.5"/><line x1="218" y1="260" x2="282" y2="260" stroke="#374151" stroke-width="1.5" stroke-dasharray="4,3"/><text x="295" y="264" fill="#374151" font-size="11">Baseline (pencil)</text><circle cx="250" cy="260" r="5" fill="#f59e0b"/><text x="250" y="282" text-anchor="middle" fill="#92400e" font-size="10">Mixture spot</text><circle cx="250" cy="210" r="5" fill="#ef4444"/><text x="136" y="214" fill="#ef4444" font-size="10" text-anchor="end">A (low Rf)</text><circle cx="250" cy="170" r="5" fill="#8b5cf6"/><text x="136" y="174" fill="#8b5cf6" font-size="10" text-anchor="end">B</text><circle cx="250" cy="120" r="5" fill="#10b981"/><text x="136" y="124" fill="#10b981" font-size="10" text-anchor="end">C (high Rf)</text><line x1="220" y1="88" x2="280" y2="88" stroke="#1d4ed8" stroke-width="1.5"/><text x="295" y="93" fill="#1d4ed8" font-size="11">Solvent front</text><line x1="305" y1="88" x2="305" y2="260" stroke="#6b7280" stroke-width="1"/><text x="318" y="178" fill="#6b7280" font-size="10">solvent dist.</text><line x1="325" y1="210" x2="325" y2="260" stroke="#ef4444" stroke-width="1"/><text x="332" y="240" fill="#ef4444" font-size="10">d(spot)</text></svg>'
      }
    },
    {
    ...
    },
    {
      ...
      data: {
        ...
        svg: '<svg viewBox="0 0 420 380" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="12"><rect x="155" y="30" width="110" height="290" rx="6" fill="#f9fafb" stroke="#6366f1" stroke-width="2.5"/><rect x="162" y="68" width="96" height="230" rx="3" fill="#e0e7ff" opacity="0.85"/><text x="210" y="92" text-anchor="middle" fill="#3730a3" font-weight="bold" font-size="11">Silica</text><text x="210" y="106" text-anchor="middle" fill="#3730a3" font-size="10">(stationary phase)</text><ellipse cx="210" cy="66" rx="48" ry="8" fill="#86efac" opacity="0.9"/><text x="210" y="50" text-anchor="middle" fill="#166534" font-weight="bold" font-size="11">Mixture + solvent added</text><rect x="164" y="225" width="92" height="22" rx="2" fill="#fef08a" opacity="0.9"/><text x="264" y="239" fill="#713f12" font-size="10">More attracted to mobile (faster)</text><rect x="164" y="160" width="92" height="22" rx="2" fill="#bfdbfe" opacity="0.9"/><text x="264" y="174" fill="#1e3a8a" font-size="10">More attracted to stationary (slower)</text><rect x="198" y="316" width="24" height="20" rx="4" fill="#6366f1"/><text x="210" y="330" text-anchor="middle" fill="white" font-size="10" font-weight="bold">Tap</text><line x1="210" y1="336" x2="210" y2="356" stroke="#f59e0b" stroke-width="3"/><ellipse cx="210" cy="368" rx="28" ry="10" fill="#fef08a" stroke="#d97706" stroke-width="1.5"/><text x="210" y="371" text-anchor="middle" fill="#92400e" font-size="10">Collect fraction 1</text></svg>'
      }
    },
    {
    ...
    },
    {
      ...
      data: {
        ...
        svg: '<svg viewBox="0 0 580 200" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="12"><rect x="10" y="60" width="60" height="80" rx="10" fill="#e0f2fe" stroke="#0369a1" stroke-width="2"/><text x="40" y="92" text-anchor="middle" fill="#0369a1" font-weight="bold" font-size="11">Carrier</text><text x="40" y="107" text-anchor="middle" fill="#0369a1" font-weight="bold" font-size="11">Gas</text><text x="40" y="121" text-anchor="middle" fill="#0369a1" font-size="10">(He / N\u2082)</text><line x1="72" y1="100" x2="95" y2="100" stroke="#6b7280" stroke-width="2" marker-end="url(#ga)"/><rect x="97" y="70" width="65" height="60" rx="6" fill="#fef3c7" stroke="#d97706" stroke-width="2"/><text x="130" y="95" text-anchor="middle" fill="#92400e" font-weight="bold" font-size="11">Injector</text><text x="130" y="110" text-anchor="middle" fill="#92400e" font-size="10">Port</text><text x="130" y="123" text-anchor="middle" fill="#92400e" font-size="10">(vaporise)</text><line x1="163" y1="100" x2="186" y2="100" stroke="#6b7280" stroke-width="2" marker-end="url(#ga)"/><rect x="188" y="30" width="180" height="140" rx="8" fill="#fef9c3" stroke="#ca8a04" stroke-width="2" stroke-dasharray="6,3"/><text x="278" y="50" text-anchor="middle" fill="#92400e" font-size="11">Oven (heated)</text><path d="M210,80 Q250,60 290,80 Q330,100 290,120 Q250,140 210,120 Q190,110 210,95" fill="none" stroke="#6d28d9" stroke-width="6" stroke-linecap="round"/><text x="278" y="116" text-anchor="middle" fill="#4c1d95" font-size="10">Coiled column</text><text x="278" y="130" text-anchor="middle" fill="#4c1d95" font-size="10">(stationary phase)</text><line x1="369" y1="100" x2="392" y2="100" stroke="#6b7280" stroke-width="2" marker-end="url(#ga)"/><rect x="394" y="70" width="70" height="60" rx="6" fill="#dcfce7" stroke="#16a34a" stroke-width="2"/><text x="429" y="96" text-anchor="middle" fill="#14532d" font-weight="bold" font-size="11">Detector</text><text x="429" y="111" text-anchor="middle" fill="#14532d" font-size="10">(FID/UV)</text><line x1="465" y1="100" x2="488" y2="100" stroke="#6b7280" stroke-width="2" marker-end="url(#ga)"/><rect x="490" y="65" width="75" height="70" rx="6" fill="#e0e7ff" stroke="#6366f1" stroke-width="2"/><text x="527" y="95" text-anchor="middle" fill="#3730a3" font-weight="bold" font-size="11">Computer</text><text x="527" y="112" text-anchor="middle" fill="#3730a3" font-size="10">Chromatogram</text><defs><marker id="ga" markerWidth="7" markerHeight="7" refX="3.5" refY="3.5" orient="auto"><path d="M0,0 L7,3.5 L0,7 Z" fill="#6b7280"/></marker></defs></svg>'
      }
    },
    {
      id: 'h-comparison',
    ...
    },
    {
      ...
      data: {
        ...
        svg: '<svg viewBox="0 0 620 230" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="12"><rect x="10" y="80" width="90" height="80" rx="8" fill="#fef3c7" stroke="#d97706" stroke-width="2"/><text x="55" y="107" text-anchor="middle" fill="#92400e" font-weight="bold">Inject</text><text x="55" y="122" text-anchor="middle" fill="#92400e">mixture</text><text x="55" y="138" text-anchor="middle" fill="#92400e" font-size="10">(A,B,C,D,E)</text><line x1="101" y1="120" x2="123" y2="120" stroke="#6b7280" stroke-width="2" marker-end="url(#gca)"/><rect x="125" y="50" width="130" height="150" rx="8" fill="#ede9fe" stroke="#7c3aed" stroke-width="2"/><text x="190" y="78" text-anchor="middle" fill="#4c1d95" font-weight="bold">GC Column</text><text x="190" y="94" text-anchor="middle" fill="#4c1d95" font-size="10">separate by</text><text x="190" y="108" text-anchor="middle" fill="#4c1d95" font-size="10">retention time</text><polyline points="138,163 148,163 152,143 158,163 165,163 172,133 178,163 186,163 194,118 200,163 210,163 218,106 224,163 240,163" fill="none" stroke="#7c3aed" stroke-width="1.5"/><text x="145" y="182" fill="#7c3aed" font-size="9">A  B    C     D      E</text><line x1="256" y1="120" x2="278" y2="120" stroke="#6b7280" stroke-width="2" marker-end="url(#gca)"/><rect x="280" y="78" width="90" height="84" rx="8" fill="#ecfdf5" stroke="#16a34a" stroke-width="2"/><text x="325" y="101" text-anchor="middle" fill="#14532d" font-weight="bold" font-size="11">Each one</text><text x="325" y="116" text-anchor="middle" fill="#14532d">enters MS</text><text x="325" y="131" text-anchor="middle" fill="#14532d">separately</text><text x="325" y="148" text-anchor="middle" fill="#166534" font-size="10">A\u2192B\u2192C\u2192D\u2192E</text><line x1="371" y1="120" x2="393" y2="120" stroke="#6b7280" stroke-width="2" marker-end="url(#gca)"/><rect x="395" y="58" width="110" height="124" rx="8" fill="#fff1f2" stroke="#e11d48" stroke-width="2"/><text x="450" y="82" text-anchor="middle" fill="#9f1239" font-weight="bold">Mass</text><text x="450" y="97" text-anchor="middle" fill="#9f1239" font-weight="bold">Spectrometer</text><text x="450" y="116" text-anchor="middle" fill="#9f1239" font-size="10">m/z spectrum</text><text x="450" y="131" text-anchor="middle" fill="#9f1239" font-size="10">fragmentation</text><text x="450" y="146" text-anchor="middle" fill="#9f1239" font-size="10">accurate Mr</text><text x="450" y="170" text-anchor="middle" fill="#9f1239" font-size="10">\u2192 identify compound</text><line x1="506" y1="120" x2="528" y2="120" stroke="#6b7280" stroke-width="2" marker-end="url(#gca)"/><rect x="530" y="72" width="78" height="96" rx="8" fill="#e0e7ff" stroke="#6366f1" stroke-width="2"/><text x="569" y="100" text-anchor="middle" fill="#3730a3" font-weight="bold" font-size="11">Database</text><text x="569" y="116" text-anchor="middle" fill="#3730a3">compare</text><text x="569" y="132" text-anchor="middle" fill="#3730a3">\u2192 confirm</text><text x="569" y="148" text-anchor="middle" fill="#3730a3">identity</text><defs><marker id="gca" markerWidth="7" markerHeight="7" refX="3.5" refY="3.5" orient="auto"><path d="M0,0 L7,3.5 L0,7 Z" fill="#6b7280"/></marker></defs></svg>'
      }
    },
    {
      id: 'list-gcms-steps',
