    ...
    blocks: [
        ...
        },
        {
            ...
            data: {
                ...
                svg: '<svg viewBox="0 0 480 210" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10"><text x="110" y="14" text-anchor="middle" font-size="11" font-weight="bold" fill="#1e293b">Diaphragm Cell</text><rect x="10" y="22" width="200" height="175" rx="6" fill="#0f172a" stroke="#94a3b8"/><rect x="20" y="45" width="80" height="140" rx="4" fill="#1e3a8a"/><text x="60" y="78" text-anchor="middle" fill="#1d4ed8">ANODE</text><text x="60" y="93" text-anchor="middle" fill="#1d4ed8">(titanium)</text><text x="60" y="120" text-anchor="middle" fill="#1d4ed8">Cl₂ ↑</text><text x="60" y="155" text-anchor="middle" fill="#1d4ed8" font-size="9">brine in →</text><line x1="104" y1="45" x2="104" y2="185" stroke="#475569" stroke-width="2" stroke-dasharray="4,3"/><text x="104" y="37" text-anchor="middle" font-size="9" fill="#475569">porous diaphragm</text><rect x="110" y="45" width="90" height="140" rx="4" fill="#0a2e1a"/><text x="155" y="78" text-anchor="middle" fill="#166534">CATHODE</text><text x="155" y="93" text-anchor="middle" fill="#166534">(steel)</text><text x="155" y="120" text-anchor="middle" fill="#166534">H₂ ↑</text><text x="155" y="145" text-anchor="middle" fill="#166534" font-size="9">NaOH(aq) dilute</text><text x="155" y="158" text-anchor="middle" fill="#166534" font-size="9">+ NaCl contamination</text><text x="370" y="14" text-anchor="middle" font-size="11" font-weight="bold" fill="#1e293b">Membrane Cell</text><rect x="270" y="22" width="200" height="175" rx="6" fill="#0f172a" stroke="#94a3b8"/><rect x="280" y="45" width="77" height="140" rx="4" fill="#1e3a8a"/><text x="318" y="78" text-anchor="middle" fill="#1d4ed8">ANODE</text><text x="318" y="93" text-anchor="middle" fill="#1d4ed8">(titanium)</text><text x="318" y="120" text-anchor="middle" fill="#1d4ed8">Cl₂ ↑</text><text x="318" y="155" text-anchor="middle" fill="#1d4ed8" font-size="9">pure brine in →</text><rect x="359" y="45" width="6" height="140" fill="#6366f1"/><text x="362" y="37" text-anchor="middle" font-size="9" fill="#6366f1">membrane (Na⁺ only)</text><rect x="369" y="45" width="91" height="140" rx="4" fill="#0a2e1a"/><text x="414" y="78" text-anchor="middle" fill="#166534">CATHODE</text><text x="414" y="93" text-anchor="middle" fill="#166534">(nickel)</text><text x="414" y="120" text-anchor="middle" fill="#166534">H₂ ↑</text><text x="414" y="145" text-anchor="middle" fill="#166534" font-size="9">NaOH(aq) pure</text><text x="414" y="158" text-anchor="middle" fill="#166534" font-size="9">~30% — no NaCl</text></svg>'
            },
            terms: []
        },
        {
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 420" font-family="system-ui,sans-serif"><text x="350" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#1e293b" letter-spacing="1">GROUP 7 HALIDE REACTIVITY LADDER</text><!-- Column headers --><rect x="10" y="32" width="680" height="30" rx="6" fill="rgba(99,102,241,0.25)" stroke="#818cf8" stroke-width="1"/><text x="60" y="50" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">HALIDE</text><text x="185" y="50" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">REDUCING ABILITY</text><text x="370" y="50" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">WITH CONC. H₂SO₄</text><text x="580" y="50" text-anchor="middle" font-size="9" fill="#2d2d72" font-weight="700">AgNO₃ TEST (acidified)</text><!-- F- row --><rect x="10" y="62" width="680" height="70" rx="0" fill="rgba(96,165,250,0.08)"/><rect x="10" y="62" width="95" height="70" fill="rgba(96,165,250,0.2)" stroke="#60a5fa" stroke-width="1"/><text x="58" y="87" text-anchor="middle" font-size="13" font-weight="800" fill="#60a5fa">F⁻</text><text x="58" y="104" text-anchor="middle" font-size="8.5" fill="#1e3a8a">fluoride</text><text x="60" y="122" text-anchor="middle" font-size="8" fill="#1250a0">weakest reducing</text><text x="185" y="90" text-anchor="middle" font-size="9" fill="#1e3a8a">None — F⁻ is a very poor</text><text x="185" y="105" text-anchor="middle" font-size="9" fill="#1e3a8a">reducing agent</text><text x="185" y="120" text-anchor="middle" font-size="8.5" fill="#1250a0">F is most electronegative — hard to oxidise</text><text x="370" y="90" text-anchor="middle" font-size="9" fill="#1e3a8a">HF only produced</text><text x="370" y="105" text-anchor="middle" font-size="8.5" fill="#1250a0">(F⁻ cannot reduce H₂SO₄)</text><text x="580" y="90" text-anchor="middle" font-size="9" fill="#2d2d72">No precipitate</text><text x="580" y="105" text-anchor="middle" font-size="8.5" fill="#818cf8">(AgF is soluble)</text><!-- Cl- row --><rect x="10" y="132" width="680" height="70" rx="0" fill="rgba(255,255,255,0.02)"/><rect x="10" y="132" width="95" height="70" fill="rgba(52,211,153,0.2)" stroke="#34d399" stroke-width="1"/><text x="58" y="157" text-anchor="middle" font-size="13" font-weight="800" fill="#34d399">Cl⁻</text><text x="58" y="174" text-anchor="middle" font-size="8.5" fill="#065f46">chloride</text><text x="185" y="160" text-anchor="middle" font-size="9" fill="#065f46">Weak — only HCl gas produced</text><text x="185" y="175" text-anchor="middle" font-size="9" fill="#065f46">Cannot reduce conc. H₂SO₄</text><text x="370" y="155" text-anchor="middle" font-size="9" fill="#065f46">HCl gas (steamy white fumes)</text><text x="370" y="170" text-anchor="middle" font-size="9" fill="#065f46">Cl⁻ + H₂SO₄ → HCl + HSO₄⁻</text><text x="370" y="187" text-anchor="middle" font-size="8" fill="#065f46">H₂SO₄ not reduced further</text><text x="580" y="157" text-anchor="middle" font-size="9" fill="#34d399">White precipitate</text><text x="580" y="172" text-anchor="middle" font-size="8.5" fill="#065f46">AgCl — dissolves in dilute NH₃</text><!-- Br- row --><rect x="10" y="202" width="680" height="70" rx="0" fill="rgba(255,255,255,0.04)"/><rect x="10" y="202" width="95" height="70" fill="rgba(251,146,60,0.2)" stroke="#fb923c" stroke-width="1"/><text x="58" y="227" text-anchor="middle" font-size="13" font-weight="800" fill="#fb923c">Br⁻</text><text x="58" y="244" text-anchor="middle" font-size="8.5" fill="#532407">bromide</text><text x="185" y="227" text-anchor="middle" font-size="9" fill="#532407">Medium — can reduce H₂SO₄ to SO₂</text><text x="185" y="243" text-anchor="middle" font-size="9" fill="#532407">Br⁻ → Br₂ (oxidised)</text><text x="370" y="222" text-anchor="middle" font-size="9" fill="#532407">HBr (fumes) + Br₂ (orange vapour)</text><text x="370" y="237" text-anchor="middle" font-size="9" fill="#532407">+ SO₂ (chokes)</text><text x="370" y="252" text-anchor="middle" font-size="8" fill="#78350f">Br⁻ reduces SO₄²⁻ to SO₂</text><text x="580" y="225" text-anchor="middle" font-size="9" fill="#fb923c">Cream precipitate</text><text x="580" y="240" text-anchor="middle" font-size="8.5" fill="#532407">AgBr — dissolves in conc. NH₃ only</text><!-- I- row --><rect x="10" y="272" width="680" height="84" rx="0" fill="rgba(244,114,182,0.06)"/><rect x="10" y="272" width="95" height="84" fill="rgba(244,114,182,0.2)" stroke="#f472b6" stroke-width="1"/><text x="58" y="297" text-anchor="middle" font-size="13" font-weight="800" fill="#f472b6">I⁻</text><text x="58" y="314" text-anchor="middle" font-size="8.5" fill="#4a1040">iodide</text><text x="58" y="330" text-anchor="middle" font-size="8" fill="#f472b6">strongest reducing</text><text x="185" y="297" text-anchor="middle" font-size="9" fill="#4a1040">Strong — reduces H₂SO₄ fully to H₂S</text><text x="185" y="313" text-anchor="middle" font-size="9" fill="#4a1040">I⁻ → I₂ (oxidised)</text><text x="185" y="328" text-anchor="middle" font-size="8.5" fill="#f472b6">Biggest ion, most polarisable, weakest H-I bond</text><text x="370" y="292" text-anchor="middle" font-size="9" fill="#4a1040">HI (fumes) + I₂ (purple/black solid)</text><text x="370" y="307" text-anchor="middle" font-size="9" fill="#4a1040">+ SO₂ + S (yellow) + H₂S (smells!)</text><text x="370" y="322" text-anchor="middle" font-size="8" fill="#78350f">I⁻ reduces SO₄²⁻ all the way to H₂S</text><text x="580" y="293" text-anchor="middle" font-size="9" fill="#f472b6">Yellow precipitate</text><text x="580" y="308" text-anchor="middle" font-size="8.5" fill="#4a1040">AgI — insoluble in any NH₃</text><!-- Key summary --><rect x="10" y="366" width="680" height="46" rx="8" fill="rgba(99,102,241,0.15)" stroke="#818cf8" stroke-width="1"/><text x="350" y="383" text-anchor="middle" font-size="9.5" fill="#2d2d72" font-weight="700">KEY: Reducing ability F⁻ &lt; Cl⁻ &lt; Br⁻ &lt; I⁻ (down the group). Use H₃PO₄ (not H₂SO₄) to prepare pure HBr or HI.</text><text x="350" y="402" text-anchor="middle" font-size="9" fill="#2d2d72">AgNO₃ test: acidify with HNO₃ first to remove CO₃²⁻/SO₃²⁻ interference. Then add AgNO₃ and NH₃ for confirmation.</text></svg>',
                caption: 'Group 7 Halide Reactivity Ladder — reducing ability increases F⁻→I⁻. With conc. H₂SO₄: Cl⁻ gives only HCl; Br⁻ gives HBr+SO₂; I⁻ gives HI+S+SO₂+H₂S. AgNO₃ test: white (Cl⁻ / dil. NH₃), cream (Br⁻ / conc. NH₃), yellow (I⁻ / no NH₃).'
            },
            terms: []
        }
    ],
