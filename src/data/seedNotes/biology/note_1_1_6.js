  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 350 150' xmlns='http://www.w3.org/2000/svg'><circle cx='80' cy='70' r='40' fill='#feb2b2' stroke='#c53030' stroke-width='12'/><circle cx='80' cy='70' r='18' fill='white'/><text x='55' y='135' font-size='12' font-weight='bold'>Artery</text><text x='20' y='15' font-size='10' fill='#c53030'>Thick Muscle/Elastic Wall</text><circle cx='250' cy='70' r='45' fill='#bee3f8' stroke='#3182ce' stroke-width='4'/><circle cx='250' cy='70' r='35' fill='white'/><text x='235' y='135' font-size='12' font-weight='bold'>Vein</text><text x='200' y='15' font-size='10' fill='#3182ce'>Thin Wall, Large Lumen</text><path d='M240,55 L250,70 L260,55' fill='none' stroke='#2b6cb0' stroke-width='2'/><text x='240' y='45' font-size='10'>Valve</text></svg>",
