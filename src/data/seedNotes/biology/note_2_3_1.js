export const note_biology_2_3_1 = {
  ...
  ,
    ...
    },
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 350 150' xmlns='http://www.w3.org/2000/svg'><circle cx='100' cy='75' r='60' fill='#ebf8ff' stroke='#3182ce' stroke-width='2'/><circle cx='100' cy='75' r='15' fill='#9f7aea'/><text x='65' y='20' font-size='12' font-weight='bold'>Eukaryote (~10-100µm)</text><text x='70' y='155' font-size='10'>80S Ribosomes</text><rect x='250' y='65' width='40' height='20' rx='10' fill='#fed7d7' stroke='#e53e3e' stroke-width='2'/><text x='220' y='20' font-size='12' font-weight='bold'>Prokaryote (~1-5µm)</text><text x='230' y='110' font-size='10'>70S Ribosomes</text><line x1='15' y1='140' x2='185' y2='140' stroke='#333' marker-end='url(#arrow)' marker-start='url(#arrow)'/><line x1='230' y1='95' x2='290' y2='95' stroke='#333' marker-end='url(#arrow)' marker-start='url(#arrow)'/></svg>",
