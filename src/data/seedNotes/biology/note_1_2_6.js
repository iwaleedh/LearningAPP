  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 300 150' xmlns='http://www.w3.org/2000/svg'><text x='50' y='30' font-size='12' font-weight='bold'>Ψ (Psi) = Water Potential</text><rect x='40' y='50' width='100' height='60' fill='#1c3a64' stroke='#4299e1'/><text x='50' y='85' font-size='12'>Ψ ≈ 0 (Pure)</text><rect x='160' y='50' width='100' height='60' fill='#1c3a64' stroke='#2b6cb0'/><text x='165' y='85' font-size='12'>Ψ < 0 (More Solute)</text><path d='M110,120 Q150,140 190,120' fill='none' stroke='#c53030' stroke-width='3' marker-end='url(#arrow)'/><text x='110' y='145' font-size='10'>Water flows to lower Ψ</text></svg>",
