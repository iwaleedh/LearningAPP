  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 450 150' xmlns='http://www.w3.org/2000/svg'><circle cx='50' cy='50' r='20' fill='#1c3a64' stroke='#3182ce'/><circle cx='50' cy='50' r='5' fill='#2b6cb0'/><text x='10' y='85' font-size='10'>Body Cell (Diploid)</text><circle cx='150' cy='50' r='20' fill='#3d1212' stroke='#e53e3e'/><circle cx='150' cy='50' r='5' fill='#c53030'/><text x='120' y='85' font-size='10'>Egg Cell (Haploid)</text><line x1='145' y1='45' x2='155' y2='55' stroke='black' stroke-width='2'/><line x1='155' y1='45' x2='145' y2='55' stroke='black' stroke-width='2'/><text x='125' y='100' font-size='8'>Remove Nucleus</text><path d='M60,60 Q105,100 150,110' fill='none' stroke='#333' marker-end='url(#arrow)'/><path d='M150,120 L200,120' fill='none' stroke='#333' marker-end='url(#arrow)'/><circle cx='230' cy='120' r='20' fill='#3d1212' stroke='#e53e3e'/><circle cx='230' cy='120' r='5' fill='#2b6cb0'/><text x='210' y='155' font-size='10'>Fused Cell (Cloned)</text><rect x='160' y='100' width='20' height='10' fill='#44370a'/><text x='155' y='95' font-size='8'>Electric shock</text></svg>",
