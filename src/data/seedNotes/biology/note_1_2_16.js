  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 300 160' xmlns='http://www.w3.org/2000/svg'><rect x='60' y='50' width='60' height='50' fill='#fff' stroke='#333'/><rect x='120' y='50' width='60' height='50' fill='#fff' stroke='#333'/><rect x='60' y='100' width='60' height='50' fill='#fff' stroke='#333'/><rect x='120' y='100' width='60' height='50' fill='#fff' stroke='#333'/><text x='85' y='40'>F</text><text x='145' y='40'>f</text><text x='40' y='80'>F</text><text x='40' y='130'>f</text><text x='75' y='80' font-weight='bold'>FF</text><text x='135' y='80' font-weight='bold'>Ff</text><text x='75' y='130' font-weight='bold'>Ff</text><text x='135' y='130' font-weight='bold'>ff</text><text x='200' y='100' font-size='11'>Ratio: 3 Dom : 1 Rec</text></svg>",
    ...
    },
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 300 150' xmlns='http://www.w3.org/2000/svg'><rect x='80' y='20' width='20' height='20' fill='#fff' stroke='#333'/><circle cx='180' cy='30' r='10' fill='#333'/><line x1='100' y1='30' x2='170' y2='30' stroke='#333' stroke-width='2'/><line x1='135' y1='30' x2='135' y2='60' stroke='#333' stroke-width='2'/><line x1='90' y1='60' x2='180' y2='60' stroke='#333' stroke-width='2'/><line x1='90' y1='60' x2='90' y2='80' stroke='#333' stroke-width='2'/><circle cx='90' cy='90' r='10' fill='#fff' stroke='#333'/><line x1='180' y1='60' x2='180' y2='80' stroke='#333' stroke-width='2'/><rect x='170' y='80' width='20' height='20' fill='#333'/><text x='210' y='35' font-size='10'>Affected Female</text><text x='210' y='90' font-size='10'>Affected Male</text></svg>",
