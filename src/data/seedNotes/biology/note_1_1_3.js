export const note_biology_1_1_3 = {
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 520 200" xmlns="http://www.w3.org/2000/svg" font-family="Inter,Arial,sans-serif" font-size="13"><defs><style>.lbl{fill:#1f2937;font-size:12px;}.muted{fill:#6b7280;font-size:10px;}</style></defs><text x="260" y="18" text-anchor="middle" font-size="13" font-weight="bold" fill="#1e1b4b">Cholesterol Structure (Simplified)</text><polygon points="55,135 80,107 120,107 145,135 120,163 80,163" fill="#2d2f72" stroke="#6366f1" stroke-width="1.5"/><text x="100" y="137" text-anchor="middle" font-size="11" fill="#1e1b4b">A</text><polygon points="145,135 170,107 210,107 235,135 210,163 170,163" fill="#2d1b69" stroke="#6366f1" stroke-width="1.5"/><text x="190" y="137" text-anchor="middle" font-size="11" fill="#1e1b4b">B</text><polygon points="235,135 260,107 300,107 325,135 300,163 260,163" fill="#2d2f72" stroke="#6366f1" stroke-width="1.5"/><text x="280" y="137" text-anchor="middle" font-size="11" fill="#1e1b4b">C</text><polygon points="325,135 355,112 385,128 385,155 355,168" fill="#2d1b69" stroke="#6366f1" stroke-width="1.5"/><text x="357" y="141" text-anchor="middle" font-size="11" fill="#1e1b4b">D</text><path d="M 385 143 L 425 130 L 455 145 L 485 130" stroke="#374151" stroke-width="1.5" fill="none"/><text x="455" y="118" text-anchor="middle" class="muted">Hydrocarbon</text><text x="455" y="130" text-anchor="middle" class="muted">tail</text><path d="M 68 135 L 52 160" stroke="#374151" stroke-width="1.5"/><text x="40" y="174" text-anchor="middle" font-size="12" fill="#16a34a" font-weight="bold">−OH</text><text x="40" y="187" text-anchor="middle" class="muted">(polar)</text><text x="260" y="195" text-anchor="middle" class="muted" font-style="italic">Four fused steroid rings — mostly hydrophobic; −OH group is weakly hydrophilic</text></svg>',
