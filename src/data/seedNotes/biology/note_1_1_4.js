  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 300 120' xmlns='http://www.w3.org/2000/svg'><rect x='20' y='30' width='30' height='50' fill='#4299e1' rx='3'/><rect x='70' y='30' width='30' height='50' fill='#48bb78' rx='3'/><rect x='120' y='30' width='30' height='50' fill='#ecc94b' rx='3'/><rect x='170' y='30' width='30' height='50' fill='#ed8936' rx='3'/><rect x='220' y='30' width='30' height='50' fill='#e53e3e' rx='3'/><line x1='15' y1='95' x2='265' y2='95' stroke='#4a5568' stroke-width='2' marker-end='url(#arrow)'/><polygon points='260,90 270,95 260,100' fill='#4a5568'/><text x='20' y='110' font-size='10' font-family='sans-serif'>None</text><text x='100' y='110' font-size='12' font-family='sans-serif'>Increasing Reducing Sugar</text><text x='220' y='110' font-size='10' font-family='sans-serif'>High</text></svg>",
            "caption": "Benedict's Test Colour Scale"
        }
    },
    {
        "id": "svg-diag-1-1-4-1",
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 400 120' xmlns='http://www.w3.org/2000/svg'><rect x='30' y='40' width='20' height='40' fill='#a0aec0' rx='2'/><text x='25' y='95' font-size='10'>Light</text><line x1='50' y1='60' x2='120' y2='60' stroke='#ecc94b' stroke-width='6'/><rect x='130' y='30' width='40' height='60' fill='#ebf8ff' stroke='#4299e1' stroke-width='2' opacity='0.8' rx='3'/><text x='132' y='20' font-size='10'>Cuvette</text><line x1='170' y1='60' x2='240' y2='60' stroke='#ecc94b' stroke-width='2'/><rect x='250' y='35' width='50' height='50' fill='#2d3748' rx='4'/><text x='257' y='65' fill='white' font-size='11'>Sensor</text><text x='320' y='55' font-size='11'>Measures</text><text x='320' y='70' font-size='11'>Absorbance</text><text x='180' y='80' font-size='9' fill='#c53030'>Less transmitted</text></svg>",
