  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 400 150' xmlns='http://www.w3.org/2000/svg'><rect x='20' y='50' width='60' height='60' fill='#0a2e1a'/><text x='20' y='130' font-size='10'>1. Tissue</text><path d='M90,80 L120,80' stroke='#333' stroke-width='2' marker-end='url(#arrow)'/><path d='M130,50 L130,110 L170,110 L170,50 Z' fill='#1e293b' stroke='#718096'/><circle cx='150' cy='80' r='5' fill='#4a5568'/><text x='110' y='140' font-size='10'>2. Homogenisation</text><text x='110' y='155' font-size='10' fill='#c53030'>(Ice-cold, Isotonic, Buffer)</text><path d='M180,80 L210,80' stroke='#333' stroke-width='2' marker-end='url(#arrow)'/><rect x='230' y='40' width='40' height='80' rx='5' fill='#1c3a64' stroke='#3182ce'/><rect x='230' y='100' width='40' height='20' fill='#2b6cb0'/><text x='220' y='140' font-size='10'>3. Centrifugation</text><text x='220' y='155' font-size='10' fill='#2b6cb0'>(Nuclei sink first)</text></svg>",
    ...
    },
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 350 150' xmlns='http://www.w3.org/2000/svg'><text x='20' y='30' font-weight='bold' font-size='12'>Speed increases to precipitate smaller organelles:</text><rect x='30' y='60' width='30' height='60' fill='#7f1d1d' stroke='#e53e3e'/><rect x='30' y='100' width='30' height='20' fill='#c53030'/><text x='20' y='135' font-size='10'>Low Speed</text><text x='15' y='150' font-size='10' fill='#c53030'>Nuclei Pellet</text><path d='M75,90 L115,90' stroke='#333' stroke-width='2' marker-end='url(#arrow)'/><rect x='130' y='60' width='30' height='60' fill='#44370a' stroke='#d69e2e'/><rect x='130' y='110' width='30' height='10' fill='#b7791f'/><text x='115' y='135' font-size='10'>Medium Speed</text><text x='105' y='150' font-size='10' fill='#b7791f'>Mitochondria Pellet</text><path d='M175,90 L215,90' stroke='#333' stroke-width='2' marker-end='url(#arrow)'/><rect x='230' y='60' width='30' height='60' fill='#0a2e1a' stroke='#38a169'/><rect x='230' y='115' width='30' height='5' fill='#2f855a'/><text x='220' y='135' font-size='10'>High Speed</text><text x='215' y='150' font-size='10' fill='#2f855a'>Ribosomes Pellet</text></svg>",
