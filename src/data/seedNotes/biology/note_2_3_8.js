  ...
  ,
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 350 150' xmlns='http://www.w3.org/2000/svg'><path d='M50,80 L300,80 L300,90 L50,90 Z' fill='#1e293b'/><rect x='100' y='80' width='40' height='10' fill='#78350f'/><text x='100' y='110' font-size='10' fill='#dd6b20'>Promoter</text><rect x='150' y='80' width='100' height='10' fill='#065f46'/><text x='170' y='110' font-size='10' fill='#38a169'>Target Gene</text><circle cx='120' cy='60' r='15' fill='#fc8181'/><text x='80' y='40' font-size='10' fill='#c53030'>Transcription Factor</text><rect x='160' y='40' width='40' height='40' rx='10' fill='#2d1b69' opacity='0.7'/><text x='165' y='65' font-size='8'>RNA Pol.</text><path d='M135,60 L155,60' stroke='#333' marker-end='url(#arrow)'/></svg>",
    ...
    },
    {
        ...
        "type": "svg",
        "data": {
            "svg": "<svg viewBox='0 0 350 150' xmlns='http://www.w3.org/2000/svg'><rect x='50' y='80' width='250' height='15' fill='#1e293b'/><rect x='60' y='80' width='30' height='15' fill='#78350f'/><rect x='90' y='80' width='30' height='15' fill='#fc8181'/><text x='95' y='110' font-size='10' fill='#c53030'>Operator</text><rect x='120' y='80' width='150' height='15' fill='#065f46'/><rect x='90' y='65' width='30' height='15' fill='#718096'/><text x='85' y='55' font-size='10'>Repressor Protein</text><rect x='30' y='50' width='50' height='30' fill='#2d1b69' opacity='0.5'/><circle cx='95' cy='65' r='5' fill='#63b3ed'/><text x='105' y='45' font-size='8' fill='#3182ce'>Inducer (binds repressor)</text><text x='150' y='110' font-size='10' fill='#38a169'>Structural Genes (e.g. lacZ)</text><path d='M50,45 Q70,20 130,40' fill='none' stroke='#333' marker-end='url(#arrow)' stroke-dasharray='4'/></svg>",
