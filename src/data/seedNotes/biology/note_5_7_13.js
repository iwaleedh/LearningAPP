  ...
  "blocks": [
    {
      ...
      "type": "objective",
      "data": {
        "text": "Understand the role of the hormone adrenaline in the 'fight or flight' response."
      }
    },
    {
      "id": "h-adrenaline",
      "type": "heading",
      "data": {
        "text": "The Fight or Flight Response",
        "level": 2
      }
    },
    {
      ...
      "type": "paragraph",
      "data": {
        "text": "During situations of stress, fear, or excitement, the sympathetic nervous system stimulates the **adrenal medulla** (the inner part of the adrenal glands) to secrete the hormone **adrenaline** into the bloodstream."
      }
    },
    {
      "id": "list-adrenaline",
    ...
    "cues": [
      {
        "id": "c1",
        "blockId": "p-adrenal",
        "prompt": "Which gland secretes adrenaline into the blood?"
      },
      {
        "id": "c2",
        "blockId": "list-adrenaline",
        "prompt": "State two distinct ways adrenaline acts to increase heart rate."
      },
      {
        "id": "c3",
        "blockId": "list-adrenaline",
        "prompt": "How does the distribution of blood change during the fight or flight response?"
      }
    ],
