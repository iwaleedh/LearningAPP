export const note_olevel_biology_18_18_0 = {
  ...
  <rect x="10" y="10" width="230" height="180" rx="6" fill="#f0f4ff" stroke="#6366f1" stroke-width="1.5"/>
  ...
  <!-- Bell curve path -->
  <path d="M45,158 Q70,155 85,130 Q100,90 130,50 Q160,90 175,130 Q190,155 215,158" fill="#a5b4fc" fill-opacity="0.5" stroke="#6366f1" stroke-width="2" stroke-linejoin="round"/>

  <!-- Discontinuous variation graph -->
  <rect x="275" y="10" width="230" height="180" rx="6" fill="#f0fdf4" stroke="#10b981" stroke-width="1.5"/>
  ...
  <!-- Bars -->
  <rect x="315" y="90" width="30" height="70" fill="#6ee7b7" stroke="#10b981" stroke-width="1"/>
  <rect x="355" y="70" width="30" height="90" fill="#6ee7b7" stroke="#10b981" stroke-width="1"/>
  <rect x="395" y="110" width="30" height="50" fill="#6ee7b7" stroke="#10b981" stroke-width="1"/>
  <rect x="435" y="120" width="30" height="40" fill="#6ee7b7" stroke="#10b981" stroke-width="1"/>
