export const note_olevel_biology_19_19_0 = {
  ...
  <!-- Sun -->
  <circle cx="50" cy="50" r="28" fill="#fde68a" stroke="#d97706" stroke-width="2"/>
  ...
  <!-- Producer -->
  <rect x="120" y="30" width="80" height="40" rx="6" fill="#86efac" stroke="#16a34a" stroke-width="2"/>
  ...
  <!-- Primary consumer -->
  <rect x="240" y="30" width="80" height="40" rx="6" fill="#a5b4fc" stroke="#6366f1" stroke-width="2"/>
  ...
  <!-- Secondary consumer -->
  <rect x="360" y="30" width="80" height="40" rx="6" fill="#fca5a5" stroke="#ef4444" stroke-width="2"/>
  ...
  <!-- Producer bar -->
  <rect x="80" y="120" width="340" height="28" rx="4" fill="#86efac" stroke="#16a34a" stroke-width="1.5"/>
  ...
  <rect x="130" y="152" width="240" height="24" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="1.5"/>
  <text x="250" y="168" text-anchor="middle" font-size="10" fill="#3730a3">Primary consumers</text>
  <!-- Secondary consumer bar -->
  <rect x="170" y="180" width="160" height="22" rx="4" fill="#fca5a5" stroke="#ef4444" stroke-width="1.5"/>
  <text x="250" y="195" text-anchor="middle" font-size="10" fill="#991b1b">Secondary consumers</text>
  <!-- Tertiary consumer bar -->
  <rect x="205" y="206" width="90" height="20" rx="4" fill="#fde68a" stroke="#ca8a04" stroke-width="1.5"/>
