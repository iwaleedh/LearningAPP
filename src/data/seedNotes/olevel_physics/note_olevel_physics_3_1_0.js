export const note_olevel_physics_3_1_0 = {
  ...
  <defs>
    <marker id="ah0" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#3b82f6"/></marker>
  ...
  <path d="M40,110 C60,110 70,44 100,44 C130,44 140,110 160,110 C180,110 190,176 220,176 C250,176 260,110 280,110 C300,110 310,44 340,44 C370,44 380,110 400,110 C420,110 430,176 460,176" stroke="#3b82f6" stroke-width="2.5" fill="none"/>
  ...
  <line x1="40" y1="208" x2="455" y2="208" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#ah0)"/>
  <text x="230" y="220" text-anchor="middle" fill="#3b82f6" font-size="11">direction of wave travel →</text>
</svg>`,
      },
    },
    {
