export const note_business_2_10_0 = {
  ...
  blocks: [
    ...
    {      id: 'enr-t10a-svg-pestle',
      type: 'svg',
      data: {
        svg: "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 380 320' font-family='Arial,sans-serif'><rect width='380' height='320' fill='#0f172a' rx='8'/><text x='190' y='18' text-anchor='middle' font-size='13' font-weight='bold' fill='#1e293b'>PESTLE Analysis</text><polygon points='190,35 310,100 310,230 190,295 70,230 70,100' fill='none' stroke='#6366f1' stroke-width='2'/><rect x='155' y='38' width='70' height='40' rx='5' fill='#6366f1'/><text x='190' y='56' text-anchor='middle' font-size='10' font-weight='bold' fill='#1e293b'>P</text><text x='190' y='70' text-anchor='middle' font-size='9' fill='#1e293b'>Political</text><rect x='300' y='100' width='72' height='40' rx='5' fill='#8b5cf6'/><text x='336' y='118' text-anchor='middle' font-size='10' font-weight='bold' fill='#1e293b'>E</text><text x='336' y='132' text-anchor='middle' font-size='9' fill='#1e293b'>Economic</text><rect x='300' y='190' width='72' height='40' rx='5' fill='#3b82f6'/><text x='336' y='208' text-anchor='middle' font-size='10' font-weight='bold' fill='#1e293b'>S</text><text x='336' y='222' text-anchor='middle' font-size='9' fill='#1e293b'>Social</text><rect x='155' y='248' width='70' height='40' rx='5' fill='#065f46'/><text x='190' y='266' text-anchor='middle' font-size='10' font-weight='bold' fill='#1e293b'>T</text><text x='190' y='280' text-anchor='middle' font-size='9' fill='#1e293b'>Technology</text><rect x='10' y='190' width='72' height='40' rx='5' fill='#78350f'/><text x='46' y='208' text-anchor='middle' font-size='10' font-weight='bold' fill='#1e293b'>L</text><text x='46' y='222' text-anchor='middle' font-size='9' fill='#1e293b'>Legal</text><rect x='10' y='100' width='72' height='40' rx='5' fill='#ef4444'/><text x='46' y='118' text-anchor='middle' font-size='10' font-weight='bold' fill='#1e293b'>E</text><text x='46' y='132' text-anchor='middle' font-size='9' fill='#1e293b'>Environment</text></svg>",
