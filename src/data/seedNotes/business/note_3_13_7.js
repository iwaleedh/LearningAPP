export const note_business_3_13_7 = {
  blocks: [
    ...
    { id: 'sum', type: 'summary', data: { text: 'CPA maps project tasks dynamically. By finding earliest start and latest finish times, managers can coordinate resources, staff, and materials explicitly efficiently.' } },
    {
      ...
      type: 'svg',
      data: {
        svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 620 320"><rect width="620" height="320" fill="#0f172a"/><circle cx="60" cy="160" r="30" fill="#1e293b" stroke="#2563eb" stroke-width="2"/><text x="60" y="155" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">0</text><text x="60" y="168" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">0</text><line x1="50" y1="160" x2="50" y2="160"/><line x1="60" y1="130" x2="60" y2="130"/><line x1="58" y1="145" x2="62" y2="145" stroke="#6b7280" stroke-width="1"/><circle cx="200" cy="100" r="30" fill="#1e293b" stroke="#2563eb" stroke-width="2"/><text x="200" y="95" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">3</text><text x="200" y="108" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">3</text><circle cx="200" cy="240" r="30" fill="#1e293b" stroke="#6b7280" stroke-width="2"/><text x="200" y="235" text-anchor="middle" font-size="9" fill="#6b7280" font-family="sans-serif">0</text><text x="200" y="248" text-anchor="middle" font-size="9" fill="#6b7280" font-family="sans-serif">5</text><circle cx="370" cy="160" r="30" fill="#1e293b" stroke="#2563eb" stroke-width="2"/><text x="370" y="155" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">5</text><text x="370" y="168" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">5</text><circle cx="520" cy="160" r="30" fill="#1e293b" stroke="#2563eb" stroke-width="2"/><text x="520" y="155" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">7</text><text x="520" y="168" text-anchor="middle" font-size="9" fill="#2563eb" font-family="sans-serif">7</text><line x1="90" y1="140" x2="170" y2="108" stroke="#ef4444" stroke-width="3"/><text x="122" y="113" font-size="11" fill="#ef4444" font-family="sans-serif" font-weight="bold">A(3)</text><line x1="90" y1="180" x2="170" y2="228" stroke="#6b7280" stroke-width="2"/><text x="110" y="220" font-size="11" fill="#6b7280" font-family="sans-serif">C(5)</text><line x1="230" y1="100" x2="340" y2="145" stroke="#ef4444" stroke-width="3"/><text x="275" y="110" font-size="11" fill="#ef4444" font-family="sans-serif" font-weight="bold">B(2)</text><line x1="230" y1="240" x2="345" y2="175" stroke="#6b7280" stroke-width="2"/><text x="265" y="230" font-size="11" fill="#6b7280" font-family="sans-serif">D(1)</text><line x1="400" y1="160" x2="490" y2="160" stroke="#ef4444" stroke-width="3"/><text x="435" y="152" font-size="11" fill="#ef4444" font-family="sans-serif" font-weight="bold">E(2)</text><text x="310" y="290" font-size="12" fill="#ef4444" font-family="sans-serif" font-weight="bold">Critical path: 1→2→4→5 = A+B+E = 7 days</text><text x="310" y="308" font-size="10" fill="#6b7280" font-family="sans-serif">Float on path via node 3 = 5−0−5 = 0 days (also critical via D if timed differently)</text></svg>`,
