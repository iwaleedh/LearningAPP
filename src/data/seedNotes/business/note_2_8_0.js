export const note_business_2_8_0 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 260' font-family='Arial,sans-serif'><rect width='400' height='260' fill='#0f172a' rx='8'/><text x='200' y='18' text-anchor='middle' font-size='12' font-weight='bold' fill='#1e293b'>Key Profitability Ratios</text><rect x='20' y='30' width='170' height='70' rx='6' fill='#0a2e1a'/><text x='105' y='54' text-anchor='middle' font-size='11' font-weight='bold' fill='#166534'>Gross Profit Margin</text><text x='105' y='70' text-anchor='middle' font-size='10' fill='#166534'>Gross Profit ÷ Revenue × 100</text><text x='105' y='86' text-anchor='middle' font-size='9' fill='#166534'>Shows: production efficiency</text><rect x='210' y='30' width='170' height='70' rx='6' fill='#0c4a6e'/><text x='295' y='50' text-anchor='middle' font-size='11' font-weight='bold' fill='#075985'>Net Profit Margin</text><text x='295' y='66' text-anchor='middle' font-size='10' fill='#075985'>Net Profit ÷ Revenue × 100</text><text x='295' y='82' text-anchor='middle' font-size='9' fill='#075985'>Shows: overall profitability</text><rect x='20' y='120' width='170' height='70' rx='6' fill='#44370a'/><text x='105' y='144' text-anchor='middle' font-size='11' font-weight='bold' fill='#92400e'>Return on Capital</text><text x='105' y='160' text-anchor='middle' font-size='10' fill='#92400e'>Net Profit ÷ Capital × 100</text><text x='105' y='176' text-anchor='middle' font-size='9' fill='#92400e'>Shows: investment efficiency</text><rect x='210' y='120' width='170' height='70' rx='6' fill='#3d1212'/><text x='295' y='140' text-anchor='middle' font-size='11' font-weight='bold' fill='#991b1b'>Current Ratio</text><text x='295' y='156' text-anchor='middle' font-size='10' fill='#991b1b'>Current Assets ÷ Current Liabilities</text><text x='295' y='172' text-anchor='middle' font-size='9' fill='#991b1b'>Ideal: 1.5–2.0</text><text x='200' y='220' text-anchor='middle' font-size='9' fill='#64748b'>Compare ratios over time and against industry benchmarks</text></svg>`,
