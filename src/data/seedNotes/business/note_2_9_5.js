export const note_business_2_9_5 = {
  blocks: [
    ...
    },
    {
      ...
      "type": "svg",
      "data": {
        "svg": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 420 180' font-family='Arial,sans-serif'><rect width='420' height='180' fill='#f8f9ff' rx='8'/><text x='210' y='18' text-anchor='middle' font-size='12' font-weight='bold' fill='#1e293b'>Lean Production Principles</text><rect x='15' y='50' width='70' height='50' rx='5' fill='#dcfce7'/><text x='50' y='72' text-anchor='middle' font-size='9' font-weight='bold' fill='#166534'>Eliminate</text><text x='50' y='86' text-anchor='middle' font-size='9' fill='#166534'>Waste</text><defs><marker id='a2' markerWidth='8' markerHeight='8' refX='6' refY='3' orient='auto'><path d='M0,0 L0,6 L8,3 z' fill='#6366f1'/></marker></defs><line x1='85' y1='75' x2='100' y2='75' stroke='#6366f1' stroke-width='2' marker-end='url(#a2)'/><rect x='100' y='50' width='70' height='50' rx='5' fill='#e0f2fe'/><text x='135' y='72' text-anchor='middle' font-size='9' font-weight='bold' fill='#075985'>Just-In-</text><text x='135' y='86' text-anchor='middle' font-size='9' fill='#075985'>Time (JIT)</text><line x1='170' y1='75' x2='185' y2='75' stroke='#6366f1' stroke-width='2' marker-end='url(#a2)'/><rect x='185' y='50' width='70' height='50' rx='5' fill='#fef9c3'/><text x='220' y='72' text-anchor='middle' font-size='9' font-weight='bold' fill='#92400e'>Kaizen</text><text x='220' y='86' text-anchor='middle' font-size='9' fill='#92400e'>Continuous</text><text x='220' y='98' text-anchor='middle' font-size='9' fill='#92400e'>Improvement</text><line x1='255' y1='75' x2='270' y2='75' stroke='#6366f1' stroke-width='2' marker-end='url(#a2)'/><rect x='270' y='50' width='70' height='50' rx='5' fill='#fce7f3'/><text x='305' y='72' text-anchor='middle' font-size='9' font-weight='bold' fill='#9d174d'>Total</text><text x='305' y='86' text-anchor='middle' font-size='9' fill='#9d174d'>Quality</text><text x='305' y='98' text-anchor='middle' font-size='9' fill='#9d174d'>Mgmt</text><line x1='340' y1='75' x2='355' y2='75' stroke='#6366f1' stroke-width='2' marker-end='url(#a2)'/><rect x='355' y='50' width='55' height='50' rx='5' fill='#6366f1'/><text x='382' y='72' text-anchor='middle' font-size='9' font-weight='bold' fill='white'>Lower</text><text x='382' y='86' text-anchor='middle' font-size='9' fill='white'>Costs +</text><text x='382' y='98' text-anchor='middle' font-size='9' fill='white'>Quality</text><text x='210' y='140' text-anchor='middle' font-size='9' fill='#64748b'>Toyota Production System is the global benchmark for lean manufacturing</text></svg>",
