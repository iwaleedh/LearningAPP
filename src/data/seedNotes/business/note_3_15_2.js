export const note_business_3_15_2 = {
  blocks: [
    ...
    { id: 'sum-1', type: 'summary', data: { text: 'Profitability ratios (gross, operating, and net margins) highlight cost control and efficiency. Liquidity ratios (current and acid test) reveal the short-term financial stability and debt-paying ability of the firm.' } },
    {
      ...
      type: 'svg',
      data: {
        svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 420"><rect width="500" height="420" fill="#f8fafc"/><circle cx="250" cy="200" r="50" fill="#4f46e5" stroke="#3730a3" stroke-width="2"/><text x="250" y="195" text-anchor="middle" font-size="12" fill="white" font-family="sans-serif" font-weight="bold">Key</text><text x="250" y="212" text-anchor="middle" font-size="12" fill="white" font-family="sans-serif" font-weight="bold">Ratios</text><circle cx="250" cy="50" r="45" fill="#dbeafe" stroke="#3b82f6" stroke-width="2"/><text x="250" y="43" text-anchor="middle" font-size="9" fill="#1d4ed8" font-family="sans-serif">GP Margin</text><text x="250" y="56" text-anchor="middle" font-size="9" fill="#1d4ed8" font-family="sans-serif">GP/Revenue×100</text><circle cx="430" cy="130" r="45" fill="#d1fae5" stroke="#10b981" stroke-width="2"/><text x="430" y="123" text-anchor="middle" font-size="9" fill="#065f46" font-family="sans-serif">NP Margin</text><text x="430" y="136" text-anchor="middle" font-size="9" fill="#065f46" font-family="sans-serif">NP/Revenue×100</text><circle cx="430" cy="275" r="45" fill="#fef3c7" stroke="#f59e0b" stroke-width="2"/><text x="430" y="268" text-anchor="middle" font-size="9" fill="#92400e" font-family="sans-serif">ROCE</text><text x="430" y="281" text-anchor="middle" font-size="9" fill="#92400e" font-family="sans-serif">Op.P/Cap.Emp×100</text><circle cx="250" cy="360" r="45" fill="#fce7f3" stroke="#ec4899" stroke-width="2"/><text x="250" y="353" text-anchor="middle" font-size="9" fill="#9d174d" font-family="sans-serif">Current Ratio</text><text x="250" y="366" text-anchor="middle" font-size="9" fill="#9d174d" font-family="sans-serif">CA/CL</text><circle cx="65" cy="275" r="45" fill="#ede9fe" stroke="#8b5cf6" stroke-width="2"/><text x="65" y="268" text-anchor="middle" font-size="9" fill="#5b21b6" font-family="sans-serif">Acid Test</text><text x="65" y="281" text-anchor="middle" font-size="9" fill="#5b21b6" font-family="sans-serif">(CA-Inv)/CL</text><line x1="250" y1="150" x2="250" y2="95" stroke="#6b7280" stroke-width="1.5"/><line x1="295" y1="175" x2="388" y2="143" stroke="#6b7280" stroke-width="1.5"/><line x1="295" y1="225" x2="388" y2="258" stroke="#6b7280" stroke-width="1.5"/><line x1="250" y1="250" x2="250" y2="315" stroke="#6b7280" stroke-width="1.5"/><line x1="205" y1="225" x2="110" y2="258" stroke="#6b7280" stroke-width="1.5"/></svg>`,
