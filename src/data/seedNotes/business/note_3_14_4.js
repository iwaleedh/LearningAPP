export const note_business_3_14_4 = {
  ...
  blocks: [
      ...
      { id: "enr-svg-1", type: "svg", data: { svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 280"><rect x="0" y="0" width="255" height="280" rx="8" fill="#4f46e5"/><text x="127" y="28" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="bold" fill="#1e293b">Shareholder Model</text><text x="18" y="60" font-family="sans-serif" font-size="10.5" fill="#2d2f72">&#x2022; Friedman: profit is the only social responsibility</text><text x="18" y="82" font-family="sans-serif" font-size="10.5" fill="#2d2f72">&#x2022; Dividends maximised</text><text x="18" y="104" font-family="sans-serif" font-size="10.5" fill="#2d2f72">&#x2022; Short-term focus</text><text x="18" y="126" font-family="sans-serif" font-size="10.5" fill="#2d2f72">&#x2022; e.g. GE Jack Welch era</text><rect x="305" y="0" width="255" height="280" rx="8" fill="#0d9488"/><text x="432" y="28" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="bold" fill="#1e293b">Stakeholder Model</text><text x="313" y="60" font-family="sans-serif" font-size="10.5" fill="#0e4a56">&#x2022; Freeman: all affected parties matter</text><text x="313" y="82" font-family="sans-serif" font-size="10.5" fill="#0e4a56">&#x2022; Long-term value</text><text x="313" y="104" font-family="sans-serif" font-size="10.5" fill="#0e4a56">&#x2022; Multiple metrics</text><text x="313" y="126" font-family="sans-serif" font-size="10.5" fill="#0e4a56">&#x2022; e.g. John Lewis, Patagonia</text><circle cx="280" cy="140" r="26" fill="#1e293b" stroke="#94a3b8" stroke-width="1.5"/><text x="280" y="146" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="bold" fill="#374151">vs</text></svg>`, caption: "Shareholder vs Stakeholder Model Comparison" } },
      { id: "enr-callout-1", type: "callout", data: { style: "worked", title: "John Lewis Partnership — The Hybrid Model", text: "John Lewis Partnership — employees ARE shareholders (partners). Staff receive annual bonuses from profits, vote on major decisions, and have representatives on the board. This IS the stakeholder model in practice — aligning shareholder and employee interests." } },
      { id: "enr-callout-2", type: "callout", data: { style: "tip", title: "Exam Tip: The Friedman Debate", text: "The debate is nuanced. Friedman argues that by maximising profit, businesses create jobs and pay taxes — benefiting all stakeholders indirectly. Counter: this ignores externalities (pollution, exploitation). The examiner wants BOTH arguments evaluated in context." } },
    {
      id: 'callout-tip-1',
      type: 'callout',
      data: {
        style: 'tip',
        title: "Examiner Tip",
        text: "This is a crucial topic for high-mark essays. Shareholder approach = profit maximization (Milton Friedman). Stakeholder approach = balancing multiple interests (Freeman). Use real cases: Amazon shareholders vs. warehouse workers, or BP shareholders vs. environmental stakeholders. Examiners love candidates who evaluate BOTH approaches fairly rather than advocating one."
      }
    },
    {
      id: 'callout-tip-2',
      ...
      data: {
        ...
        text: "Claiming the stakeholder approach is 'always better' or 'more ethical' without cost analysis. Stakeholder management is EXPENSIVE (compliance, consultation, slower decisions). Examiners expect balanced evaluation \u2014 acknowledge that the shareholder model delivers efficiency and clear accountability, while admitting its risks (short-termism, social damage)."
      }
    }
    ],
  recall: {
