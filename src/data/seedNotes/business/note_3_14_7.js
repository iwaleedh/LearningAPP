export const note_business_3_14_7 = {
  ...
  blocks: [
      ...
      { id: "enr-worked-1", type: "callout", data: { style: "worked", title: "Worked Example: FTSE 100 CEO Pay Gap (2023)", text: "FTSE 100 CEO average pay (2023): £3.38 million. Median UK worker pay: £33,000. CEO:worker ratio = 103:1. In 1980 this ratio was 20:1. The growth in executive pay has far outpaced productivity growth — raising serious questions about whether pay rewards genuine performance or simply reflects executive power over remuneration committees." } },
      { id: "enr-worked-2", type: "callout", data: { style: "worked", title: "Worked Example: Elon Musk's Tesla Pay Package", text: "Elon Musk's 2018 Tesla pay package was worth up to $56 billion if Tesla hit a series of market capitalisation and revenue targets. In 2024, a Delaware court ruled that shareholders had not been properly informed when approving the package — it was voided. This illustrates how executive pay governance can fail: remuneration committees may lack independence, and shareholder votes can be compromised by information asymmetry." } },
      { id: "enr-tip-1", type: "callout", data: { style: "tip", title: "Exam Tip: Principal-Agent Problem", text: "The principal-agent problem is key here: executives (agents) may pursue their own interests — large bonuses, empire-building acquisitions — rather than shareholders' interests (long-run profit). Solutions include: performance-related pay tied to long-term metrics, genuinely independent non-executive directors on remuneration committees, and binding shareholder voting rights on pay packages. Evaluate which solution is most effective in context." } }
    ],
  recall: {
      enabled: true,
      ready: true,
