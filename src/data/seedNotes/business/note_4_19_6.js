export const note_business_4_19_6 = {
    blocks: [
        { id: "obj-19-6", type: "objective", data: { text: "Evaluate the risks associated with branding and language translation in international markets." } },
        { id: "h-1", type: "heading", data: { text: "Branding and Language Risks", level: 2 } },
        { id: "p-1", type: "paragraph", data: { text: "When a firm expands globally, it must translate its brand name, marketing messages, and slogans into new languages. This process is fraught with risks that can compromise the brand's image and result in expensive marketing disasters." } },
        { id: "h-2", type: "heading", data: { text: "Language and Translation Errors", level: 3 } },
        { id: "p-2", type: "paragraph", data: { text: "Direct literal translation from one language to another often strips away nuance, humor, or context, and can even change a positive message into an offensive or ridiculous one." } },
        { id: "list-1", type: "list", data: { style: "bullet", items: [
            { text: "Unintended Meanings: A brand name might mean something completely different (or vulgar) in another language." },
        ...
        { id: "list-2", type: "list", data: { style: "bullet", items: [
            { text: "Brand Dilution: If an ethnocentric brand is forced to adapt too heavily to local markets, it might lose its core identity and what originally made it successful." },
            { text: "Counterfeiting and Trademark Issues: In some countries, intellectual property laws are weak. Brands risk their names being copied or stolen ('passing off'), damaging their premium reputation." },
            { text: "Multiple Brand Names: Sometimes a firm buys a local business but keeps the local brand name (e.g., Walkers Crisps in the UK, Lays elsewhere). Managing multiple brand identities increases marketing costs and breaks down global economies of scale." }
        ]}},
        { id: "sum-1", type: "summary", data: { text: "To mitigate branding and language risks, firms should use rigorous 'back-translation', hire native experts, and conduct extensive local market testing before launching major global campaigns." } },
    ...
    recall: {
        enabled: true,
        ready: true,
        summaryText: "Firms face risks extending global brands, including lost-in-translation slogans, unintended brand name meanings, trademark theft, and brand dilution.",
        cues: [
            { id: "cue-1", blockId: "p-2", prompt: "What is the danger of direct literal translation for marketing slogans?", answer: "It often removes cultural nuance, humor, and can change a positive message into an unintended, offensive, or confusing one." },
            { id: "cue-2", blockId: "list-1", prompt: "How can translated instructions pose a significant risk?", answer: "Poor translations can lead to product misuse, angering consumers, and inviting legal liabilities." },
            { id: "cue-3", blockId: "list-2", prompt: "What is brand dilution?", answer: "When a brand loses its core identity and distinct value because it has been adapted too heavily or inconsistently across different markets." },
            { id: "cue-4", blockId: "list-2", prompt: "Explain a trademark risk businesses face globally.", answer: "Some countries have weak intellectual property laws, leaving global brands vulnerable to counterfeiting and copying, which damages their premium image." },
            { id: "cue-5", blockId: "sum-1", prompt: "How can a business mitigate language translation risks?", answer: "By employing native speakers, utilizing 'back-translation' checks, and conducting local market testing before a full launch." }
        ]
    }
};