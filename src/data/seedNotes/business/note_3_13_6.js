export const note_business_3_13_6 = {
  blocks: [
    ...
    { id: 'sum', type: 'summary', data: { text: 'Decision trees use probability and financial data to calculate Expected Values and Net Gains for different options. Whilst highly logical, the model heavily relies on the accuracy of the probabilities estimated.' } },
    {
      ...
      type: 'svg',
      data: {
        svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 620 400"><rect width="620" height="400" fill="#f8fafc"/><rect x="20" y="170" width="80" height="40" rx="4" fill="#4f46e5" stroke="#3730a3" stroke-width="2"/><text x="60" y="194" text-anchor="middle" font-size="11" fill="white" font-family="sans-serif">Decision</text><line x1="100" y1="175" x2="170" y2="130" stroke="#6b7280" stroke-width="2"/><line x1="100" y1="205" x2="170" y2="250" stroke="#6b7280" stroke-width="2"/><circle cx="180" cy="125" r="18" fill="#f59e0b" stroke="#d97706" stroke-width="2"/><text x="180" y="129" text-anchor="middle" font-size="10" fill="white" font-family="sans-serif">A</text><circle cx="180" cy="255" r="18" fill="#f59e0b" stroke="#d97706" stroke-width="2"/><text x="180" y="259" text-anchor="middle" font-size="10" fill="white" font-family="sans-serif">B</text><line x1="198" y1="120" x2="290" y2="80" stroke="#10b981" stroke-width="2"/><line x1="198" y1="130" x2="290" y2="155" stroke="#ef4444" stroke-width="2"/><line x1="198" y1="250" x2="290" y2="210" stroke="#10b981" stroke-width="2"/><line x1="198" y1="260" x2="290" y2="290" stroke="#ef4444" stroke-width="2"/><text x="235" y="75" font-size="10" fill="#059669" font-family="sans-serif">Success 0.7</text><text x="235" y="150" font-size="10" fill="#dc2626" font-family="sans-serif">Failure 0.3</text><text x="235" y="205" font-size="10" fill="#059669" font-family="sans-serif">Success 0.5</text><text x="235" y="285" font-size="10" fill="#dc2626" font-family="sans-serif">Failure 0.5</text><rect x="295" y="65" width="90" height="30" rx="3" fill="#d1fae5"/><text x="340" y="84" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#065f46">£500k</text><rect x="295" y="140" width="90" height="30" rx="3" fill="#fee2e2"/><text x="340" y="159" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#991b1b">-£50k</text><rect x="295" y="195" width="90" height="30" rx="3" fill="#d1fae5"/><text x="340" y="214" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#065f46">£400k</text><rect x="295" y="275" width="90" height="30" rx="3" fill="#fee2e2"/><text x="340" y="294" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#991b1b">-£80k</text><rect x="410" y="105" width="180" height="50" rx="4" fill="#eff6ff" stroke="#3b82f6" stroke-width="1"/><text x="500" y="126" text-anchor="middle" font-size="10" font-family="sans-serif" fill="#1d4ed8">EMV(A) = 0.7×500 + 0.3×(-50)</text><text x="500" y="144" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#1d4ed8" font-weight="bold">= £335k</text><rect x="410" y="225" width="180" height="50" rx="4" fill="#eff6ff" stroke="#3b82f6" stroke-width="1"/><text x="500" y="246" text-anchor="middle" font-size="10" font-family="sans-serif" fill="#1d4ed8">EMV(B) = 0.5×400 + 0.5×(-80)</text><text x="500" y="264" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#1d4ed8" font-weight="bold">= £160k</text><text x="310" y="365" font-size="12" font-family="sans-serif" fill="#4f46e5" font-weight="bold">Choose A: highest EMV (£335k)</text></svg>`,
