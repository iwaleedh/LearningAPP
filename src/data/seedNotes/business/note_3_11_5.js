export const note_business_3_11_5 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 440 360' font-family='Arial,sans-serif'><rect width='440' height='360' fill='#f9fafb' rx='8'/><text x='220' y='26' text-anchor='middle' font-size='14' font-weight='bold' fill='#1f2937'>BCG Matrix — Product Portfolio</text><rect x='50' y='45' width='170' height='140' fill='#dbeafe' stroke='#3b82f6' stroke-width='2' rx='4'/><text x='135' y='80' text-anchor='middle' font-size='20' fill='#1d4ed8'>+</text><text x='135' y='102' text-anchor='middle' font-size='14' font-weight='bold' fill='#1d4ed8'>Stars</text><text x='135' y='120' text-anchor='middle' font-size='10' fill='#1e40af'>High share, High growth</text><text x='135' y='136' text-anchor='middle' font-size='10' fill='#1e40af'>Invest and Grow</text><text x='135' y='154' text-anchor='middle' font-size='9' fill='#374151' font-style='italic'>e.g. iPhone (growth phase)</text><rect x='230' y='45' width='170' height='140' fill='#fef3c7' stroke='#f59e0b' stroke-width='2' rx='4'/><text x='315' y='82' text-anchor='middle' font-size='26' fill='#b45309'>?</text><text x='315' y='104' text-anchor='middle' font-size='14' font-weight='bold' fill='#b45309'>Question Marks</text><text x='315' y='122' text-anchor='middle' font-size='10' fill='#92400e'>Low share, High growth</text><text x='315' y='138' text-anchor='middle' font-size='10' fill='#92400e'>Selective invest / divest</text><text x='315' y='154' text-anchor='middle' font-size='9' fill='#374151' font-style='italic'>e.g. Apple Vision Pro (2024)</text><rect x='50' y='195' width='170' height='140' fill='#d1fae5' stroke='#10b981' stroke-width='2' rx='4'/><text x='135' y='232' text-anchor='middle' font-size='22' fill='#065f46'>$</text><text x='135' y='255' text-anchor='middle' font-size='14' font-weight='bold' fill='#065f46'>Cash Cows</text><text x='135' y='273' text-anchor='middle' font-size='10' fill='#065f46'>High share, Low growth</text><text x='135' y='289' text-anchor='middle' font-size='10' fill='#065f46'>Milk / Maintain</text><text x='135' y='306' text-anchor='middle' font-size='9' fill='#374151' font-style='italic'>e.g. MacBook Pro (stable)</text><rect x='230' y='195' width='170' height='140' fill='#fee2e2' stroke='#ef4444' stroke-width='2' rx='4'/><text x='315' y='232' text-anchor='middle' font-size='22' fill='#b91c1c'>X</text><text x='315' y='255' text-anchor='middle' font-size='14' font-weight='bold' fill='#b91c1c'>Dogs</text><text x='315' y='273' text-anchor='middle' font-size='10' fill='#b91c1c'>Low share, Low growth</text><text x='315' y='289' text-anchor='middle' font-size='10' fill='#b91c1c'>Divest / Harvest</text><text x='315' y='306' text-anchor='middle' font-size='9' fill='#374151' font-style='italic'>e.g. iPod (discontinued 2022)</text><text x='25' y='195' text-anchor='middle' font-size='10' fill='#6b7280' transform='rotate(-90,25,195)'>Market Growth Rate</text><text x='135' y='350' text-anchor='middle' font-size='10' fill='#6b7280'>High Market Share</text><text x='315' y='350' text-anchor='middle' font-size='10' fill='#6b7280'>Low Market Share</text></svg>",
