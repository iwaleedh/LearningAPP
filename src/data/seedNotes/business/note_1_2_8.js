export const note_business_1_2_8 = {
  noteId: 'note:business:1:2:8',
  subject: 'business',
  unitCode: 'WBS11',
  unitId: 1,
  topicId: 2,
  subtopicIndex: 8,
  title: 'Elasticity implications for pricing',
  ...
  recall: {
    enabled: true,
    summaryText: "PED and YED provide actionable data for businesses, allowing them to segment markets, adjust to economic cycles, and shape their product portfolios to mitigate risk.",
    cues: [
