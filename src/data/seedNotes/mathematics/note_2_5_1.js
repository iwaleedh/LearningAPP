...
export const note_mathematics_2_5_1 = {
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 220" width="300" height="220"><defs><marker id="ah63" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><line x1="30" y1="10" x2="30" y2="200" stroke="#374151" stroke-width="1.5" marker-end="url(#ah63)"/><line x1="10" y1="110" x2="280" y2="110" stroke="#374151" stroke-width="1.5" marker-end="url(#ah63)"/><text x="275" y="124" font-size="11" fill="#374151" font-family="sans-serif">x</text><text x="38" y="15" font-size="11" fill="#374151" font-family="sans-serif">y</text><path d="M 31,200 Q 35,170 45,148 Q 60,120 85,100 Q 110,82 145,65 Q 175,52 210,42 Q 240,34 270,26" stroke="#2563eb" stroke-width="2.5" fill="none"/><text x="240" y="22" font-size="13" fill="#2563eb" font-family="sans-serif" font-style="italic">y = ln x</text><circle cx="57" cy="110" r="4" fill="#10b981"/><text x="62" y="106" font-size="11" fill="#10b981" font-family="sans-serif">(1, 0)</text><circle cx="103" cy="80" r="4" fill="#10b981"/><text x="108" y="76" font-size="11" fill="#10b981" font-family="sans-serif">(e, 1)</text><line x1="30" y1="10" x2="30" y2="210" stroke="#2563eb" stroke-width="1" stroke-dasharray="4,3"/><text x="5" y="220" font-size="10" fill="#2563eb" font-family="sans-serif">asymptote x=0</text></svg>',
