...
export const note_mathematics_1_1_6 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" style="width:100%;max-width:460px;display:block;margin:0 auto;"><style>.d-lbl{font-family:sans-serif;font-size:10px;fill:#374151}.d-hl{font-family:sans-serif;font-size:10px;fill:#2563eb;font-weight:700}.d-sub{font-family:sans-serif;font-size:9px;fill:#6b7280}</style><line x1="0" y1="155" x2="120" y2="155" stroke="#e5e7eb" stroke-width="1"/><line x1="120" y1="155" x2="240" y2="155" stroke="#e5e7eb" stroke-width="1"/><line x1="240" y1="155" x2="360" y2="155" stroke="#e5e7eb" stroke-width="1"/><line x1="120" y1="10" x2="120" y2="195" stroke="#d1d5db" stroke-width="1" stroke-dasharray="3,3"/><line x1="240" y1="10" x2="240" y2="195" stroke="#d1d5db" stroke-width="1" stroke-dasharray="3,3"/><polyline points="10,130 25,155 40,165 60,165 75,155 90,130" fill="none" stroke="#2563eb" stroke-width="2.5" stroke-linejoin="round"/><circle cx="25" cy="155" r="4" fill="#2563eb"/><circle cx="75" cy="155" r="4" fill="#2563eb"/><text x="60" y="15" text-anchor="middle" class="d-hl">\u0394 &gt; 0</text><text x="60" y="26" text-anchor="middle" class="d-sub">Two distinct roots</text><polyline points="130,155 150,165 170,175 180,178 190,175 210,165 230,155" fill="none" stroke="#2563eb" stroke-width="2.5" stroke-linejoin="round"/><circle cx="180" cy="178" r="4" fill="#10b981"/><text x="180" y="15" text-anchor="middle" class="d-hl">\u0394 = 0</text><text x="180" y="26" text-anchor="middle" class="d-sub">One repeated root</text><polyline points="250,100 265,125 275,140 290,145 305,140 315,125 330,100" fill="none" stroke="#2563eb" stroke-width="2.5" stroke-linejoin="round"/><text x="300" y="15" text-anchor="middle" class="d-hl">\u0394 &lt; 0</text><text x="300" y="26" text-anchor="middle" class="d-sub">No real roots</text><line x1="10" y1="155" x2="110" y2="155" stroke="#374151" stroke-width="1.5"/><line x1="130" y1="155" x2="230" y2="155" stroke="#374151" stroke-width="1.5"/><line x1="250" y1="155" x2="350" y2="155" stroke="#374151" stroke-width="1.5"/></svg>',
