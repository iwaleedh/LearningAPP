...
export const note_mathematics_1_1_7 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 160" style="width:100%;max-width:480px;display:block;margin:0 auto;"><defs><marker id="ahg7" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L6,3 z" fill="#374151"/></marker></defs><style>.gt7{font-family:sans-serif;font-size:14px;fill:#374151;font-weight:600}.glt7{font-family:sans-serif;font-size:12px;fill:#6b7280}</style><rect x="40" y="40" width="80" height="80" fill="#f3f4f6" stroke="#4f46e5" stroke-width="1.5"/><rect x="120" y="40" width="30" height="80" fill="#e0e7ff" stroke="#4f46e5" stroke-width="1.5"/><text x="80" y="85" text-anchor="middle" class="gt7">x²</text><text x="135" y="85" text-anchor="middle" class="gt7">bx</text><text x="80" y="32" text-anchor="middle" class="glt7">x</text><text x="135" y="32" text-anchor="middle" class="glt7">b</text><text x="28" y="85" text-anchor="middle" class="glt7">x</text><text x="180" y="85" text-anchor="middle" class="gt7">→</text><rect x="230" y="40" width="80" height="80" fill="#f3f4f6" stroke="#4f46e5" stroke-width="1.5"/><rect x="310" y="40" width="20" height="80" fill="#e0e7ff" stroke="#4f46e5" stroke-width="1.5"/><rect x="230" y="120" width="80" height="20" fill="#e0e7ff" stroke="#4f46e5" stroke-width="1.5"/><rect x="310" y="120" width="20" height="20" fill="#fef2f2" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="4,2"/><text x="270" y="85" text-anchor="middle" class="gt7">x²</text><text x="270" y="135" text-anchor="middle" class="gt7" font-size="10" fill="#4f46e5">½bx</text><text x="320" y="85" text-anchor="middle" class="gt7" font-size="10" fill="#4f46e5">½bx</text><text x="320" y="135" text-anchor="middle" class="gt7" font-size="10" fill="#ef4444">(b/2)²</text><path d="M 335 150 Q 355 160 380 140" fill="none" stroke="#ef4444" stroke-width="1.5" marker-end="url(#ahg7)"/><text x="380" y="130" class="glt7" fill="#ef4444">Missing piece</text></svg>',
