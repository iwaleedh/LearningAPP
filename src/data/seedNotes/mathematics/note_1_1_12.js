...
export const note_mathematics_1_1_12 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 180" style="width:100%;max-width:320px;display:block;margin:0 auto;"><defs><marker id="ah12" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><style>.t12{font-family:sans-serif;font-size:12px;fill:#374151;font-weight:600}.l12{font-family:sans-serif;font-size:10px;fill:#6b7280}</style><line x1="20" y1="140" x2="260" y2="140" stroke="#374151" stroke-width="1.5" marker-end="url(#ah12)"/><line x1="60" y1="160" x2="60" y2="20" stroke="#374151" stroke-width="1.5" marker-end="url(#ah12)"/><text x="250" y="155" class="t12">x</text><text x="45" y="30" class="t12">y</text><polyline points="30,160 140,50" fill="none" stroke="#2563eb" stroke-width="2"/><text x="145" y="45" class="t12" fill="#2563eb">y = x − 1</text><polyline points="180,20 80,170" fill="none" stroke="#10b981" stroke-width="2"/><text x="185" y="25" class="t12" fill="#10b981">2x + 3y = 12</text><circle cx="120" cy="80" r="4" fill="#374151"/><line x1="120" y1="80" x2="120" y2="140" stroke="#374151" stroke-width="1" stroke-dasharray="3,3"/><line x1="120" y1="80" x2="60" y2="80" stroke="#374151" stroke-width="1" stroke-dasharray="3,3"/><text x="117" y="155" class="t12">3</text><text x="45" y="84" class="t12">2</text><text x="70" y="70" class="t12">Solution: (3, 2)</text></svg>',
