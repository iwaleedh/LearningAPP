...
export const note_mathematics_2_6_0 = {
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 240" width="260" height="240"><defs><marker id="ah65" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><line x1="20" y1="120" x2="240" y2="120" stroke="#374151" stroke-width="1.5" marker-end="url(#ah65)"/><line x1="130" y1="15" x2="130" y2="225" stroke="#374151" stroke-width="1.5" marker-end="url(#ah65)"/><circle cx="130" cy="120" r="80" stroke="#2563eb" stroke-width="1.8" fill="none"/><text x="232" y="133" font-size="11" fill="#374151" font-family="sans-serif">x</text><text x="138" y="18" font-size="11" fill="#374151" font-family="sans-serif">y</text><circle cx="187" cy="83" r="5" fill="#10b981"/><line x1="130" y1="120" x2="187" y2="83" stroke="#2563eb" stroke-width="2"/><line x1="187" y1="83" x2="187" y2="120" stroke="#374151" stroke-width="1.5" stroke-dasharray="4,3"/><line x1="130" y1="120" x2="187" y2="120" stroke="#374151" stroke-width="1.5" stroke-dasharray="4,3"/><text x="155" y="116" font-size="12" fill="#374151" font-family="sans-serif">cos θ</text><text x="192" y="105" font-size="12" fill="#374151" font-family="sans-serif">sin θ</text><text x="195" y="82" font-size="12" fill="#10b981" font-family="sans-serif">P(cos θ, sin θ)</text><path d="M 147,120 A 17,17 0 0,0 143,108" stroke="#2563eb" stroke-width="1.2" fill="none"/><text x="153" y="113" font-size="11" fill="#2563eb" font-family="sans-serif">θ</text><text x="60" y="200" font-size="11" fill="#2563eb" font-family="sans-serif">radius = 1 → sin²θ + cos²θ = 1²</text></svg>',
