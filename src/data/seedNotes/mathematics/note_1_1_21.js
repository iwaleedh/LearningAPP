...
export const note_mathematics_1_1_21 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 200" style="width:100%;max-width:340px;display:block;margin:0 auto;"><defs><marker id="ah21" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><style>.l21{font-family:sans-serif;font-size:10px;fill:#374151}.h21{font-family:sans-serif;font-size:10px;fill:#2563eb;font-weight:600}.g21{font-family:sans-serif;font-size:10px;fill:#10b981;font-weight:600}</style><line x1="15" y1="140" x2="265" y2="140" stroke="#374151" stroke-width="1.5" marker-end="url(#ah21)"/><line x1="70" y1="195" x2="70" y2="15" stroke="#374151" stroke-width="1.5" marker-end="url(#ah21)"/><polyline points="15,165 40,130 70,70 100,35 130,20 160,27 190,55 210,80 240,130 260,165" fill="none" stroke="#2563eb" stroke-width="2.5" stroke-linejoin="round"/><line x1="15" y1="120" x2="260" y2="70" stroke="#10b981" stroke-width="2"/><circle cx="50" cy="130" r="4.5" fill="#ef4444"/><circle cx="185" cy="90" r="4.5" fill="#ef4444"/><text x="36" y="125" class="h21">x\u2081</text><text x="188" y="84" class="h21">x\u2082</text><text x="220" y="68" class="g21">y = g(x)</text><text x="230" y="138" class="h21">y = f(x)</text><text x="258" y="154" class="l21">x</text><text x="74" y="12" class="l21">y</text></svg>',
