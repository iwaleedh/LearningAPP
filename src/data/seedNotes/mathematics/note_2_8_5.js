...
export const note_mathematics_2_8_5 = {
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 185" width="320" height="185"><defs><marker id="ah68" markerWidth="7" markerHeight="5" refX="6" refY="2.5" orient="auto"><path d="M0,0 L0,5 L7,2.5 z" fill="#374151"/></marker></defs><line x1="30" y1="155" x2="300" y2="155" stroke="#374151" stroke-width="1.5" marker-end="url(#ah68)"/><line x1="40" y1="15" x2="40" y2="160" stroke="#374151" stroke-width="1.5" marker-end="url(#ah68)"/><path d="M 60,130 Q 120,60 180,50 Q 230,45 260,80" stroke="#2563eb" stroke-width="2" fill="none"/><polygon points="60,155 60,130 110,90 110,155" fill="#2563eb" fill-opacity="0.2" stroke="#2563eb" stroke-width="1"/><polygon points="110,155 110,90 160,56 160,155" fill="#2563eb" fill-opacity="0.2" stroke="#2563eb" stroke-width="1"/><polygon points="160,155 160,56 210,51 210,155" fill="#2563eb" fill-opacity="0.2" stroke="#2563eb" stroke-width="1"/><polygon points="210,155 210,51 260,80 260,155" fill="#2563eb" fill-opacity="0.2" stroke="#2563eb" stroke-width="1"/><text x="82" y="172" font-size="10" fill="#374151" font-family="sans-serif">h</text><text x="133" y="172" font-size="10" fill="#374151" font-family="sans-serif">h</text><text x="183" y="172" font-size="10" fill="#374151" font-family="sans-serif">h</text><text x="233" y="172" font-size="10" fill="#374151" font-family="sans-serif">h</text><text x="53" y="142" font-size="9" fill="#374151" font-family="sans-serif">y₀</text><text x="103" y="85" font-size="9" fill="#374151" font-family="sans-serif">y₁</text><text x="153" y="52" font-size="9" fill="#374151" font-family="sans-serif">y₂</text><text x="203" y="47" font-size="9" fill="#374151" font-family="sans-serif">y₃</text><text x="253" y="76" font-size="9" fill="#374151" font-family="sans-serif">y₄</text><text x="290" y="158" font-size="11" fill="#374151" font-family="sans-serif">x</text><text x="44" y="13" font-size="11" fill="#374151" font-family="sans-serif">y</text></svg>',
