...
export const note_mathematics_1_1_14 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" style="width:100%;max-width:400px;display:block;margin:0 auto;"><defs><marker id="ah14" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><style>.l14{font-family:sans-serif;font-size:11px;fill:#374151}.h14{font-family:sans-serif;font-size:11px;fill:#2563eb;font-weight:600}</style><line x1="15" y1="130" x2="305" y2="130" stroke="#374151" stroke-width="1.5" marker-end="url(#ah14)"/><line x1="160" y1="195" x2="160" y2="15" stroke="#374151" stroke-width="1.5" marker-end="url(#ah14)"/><path d="M60,190 Q95,90 130,130 Q160,155 190,130 Q225,90 260,190" fill="#2563eb" fill-opacity="0.4" stroke="none"/><polyline points="60,190 80,162 100,140 120,130 130,130 140,126 160,125 180,126 190,130 200,138 220,157 240,178 260,190" fill="none" stroke="#2563eb" stroke-width="2.5" stroke-linejoin="round"/><circle cx="130" cy="130" r="4.5" fill="#2563eb"/><circle cx="190" cy="130" r="4.5" fill="#2563eb"/><circle cx="160" cy="125" r="4" fill="#10b981"/><text x="116" y="148" class="h14">x\u2081</text><text x="181" y="148" class="h14">x\u2082</text><text x="162" y="120" style="font-family:sans-serif;font-size:10px;fill:#10b981">min</text><text x="64" y="120" style="font-family:sans-serif;font-size:10px;fill:#6b7280">x &lt; x\u2081</text><text x="197" y="120" style="font-family:sans-serif;font-size:10px;fill:#6b7280">x &gt; x\u2082</text><text x="128" y="175" style="font-family:sans-serif;font-size:10px;fill:#2563eb">x\u2081 &lt; x &lt; x\u2082</text><rect x="127" y="130" width="63" height="40" fill="#2563eb" fill-opacity="0.07" stroke="none"/><text x="297" y="145" class="l14">x</text><text x="165" y="12" class="l14">y</text></svg>',
