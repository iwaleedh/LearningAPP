...
export const note_mathematics_1_1_18 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 210" style="width:100%;max-width:380px;display:block;margin:0 auto;"><defs><marker id="ah18" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><style>.l18{font-family:sans-serif;font-size:10px;fill:#374151}.h18{font-family:sans-serif;font-size:10px;fill:#2563eb;font-weight:600}.g18{font-family:sans-serif;font-size:10px;fill:#10b981;font-weight:600}</style><line x1="15" y1="130" x2="285" y2="130" stroke="#374151" stroke-width="1.5" marker-end="url(#ah18)"/><line x1="150" y1="205" x2="150" y2="15" stroke="#374151" stroke-width="1.5" marker-end="url(#ah18)"/><polyline points="90,195 100,175 110,155 120,140 130,133 140,131 150,130 160,131 170,133 180,140 190,155 200,175 210,195" fill="none" stroke="#374151" stroke-width="1.5" stroke-dasharray="5,3" stroke-linejoin="round"/><polyline points="90,180 100,160 110,143 120,130 130,122 140,120 150,119 160,120 170,122 180,130 190,143 200,160 210,180" fill="none" stroke="#10b981" stroke-width="2" stroke-linejoin="round"/><polyline points="150,195 160,175 170,155 180,140 190,133 200,131 210,130 220,131 230,133 240,140 250,155 260,175 270,195" fill="none" stroke="#2563eb" stroke-width="2" stroke-linejoin="round"/><circle cx="150" cy="130" r="4" fill="#374151"/><circle cx="150" cy="119" r="4" fill="#10b981"/><circle cx="210" cy="130" r="4" fill="#2563eb"/><text x="80" y="125" class="l18">y = x²</text><text x="48" y="112" class="g18">y = x² + 1</text><text x="188" y="125" class="h18">y = (x\u22122)²</text><text x="278" y="144" class="l18">x</text><text x="155" y="12" class="l18">y</text><text x="153" y="143" class="l18">O</text></svg>',
