...
export const note_mathematics_1_1_15 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 220" style="width:100%;max-width:340px;display:block;margin:0 auto;"><defs><marker id="ah15" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><style>.l15{font-family:sans-serif;font-size:11px;fill:#374151}.h15{font-family:sans-serif;font-size:11px;fill:#2563eb;font-weight:600}</style><polygon points="80,140 200,140 80,20" fill="#2563eb" fill-opacity="0.15" stroke="none"/><line x1="15" y1="140" x2="265" y2="140" stroke="#374151" stroke-width="1.5" marker-end="url(#ah15)"/><line x1="80" y1="205" x2="80" y2="15" stroke="#374151" stroke-width="1.5" marker-end="url(#ah15)"/><line x1="80" y1="140" x2="80" y2="205" stroke="#374151" stroke-width="1.5"/><line x1="15" y1="140" x2="80" y2="140" stroke="#374151" stroke-width="1.5"/><line x1="200" y1="140" x2="80" y2="20" stroke="#2563eb" stroke-width="2" stroke-dasharray="6,3"/><circle cx="200" cy="140" r="4" fill="#2563eb"/><circle cx="80" cy="20" r="4" fill="#2563eb"/><circle cx="80" cy="140" r="4" fill="#2563eb"/><text x="195" y="155" class="h15">4</text><text x="68" y="18" class="h15">4</text><text x="83" y="155" class="l15">O</text><text x="258" y="155" class="l15">x</text><text x="85" y="12" class="l15">y</text><text x="130" y="90" style="font-family:sans-serif;font-size:9px;fill:#2563eb">feasible region</text><text x="130" y="104" style="font-family:sans-serif;font-size:9px;fill:#2563eb">(shaded)</text></svg>',
