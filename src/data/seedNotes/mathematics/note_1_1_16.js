...
export const note_mathematics_1_1_16 = {
    ...
    blocks: [
        ...
        },
        {
            ...
            type: 'svg',
            data: {
                svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 200" style="width:100%;max-width:340px;display:block;margin:0 auto;"><defs><marker id="ah16" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#374151"/></marker></defs><style>.l16{font-family:sans-serif;font-size:11px;fill:#374151}.h16{font-family:sans-serif;font-size:11px;fill:#2563eb;font-weight:600}</style><line x1="15" y1="120" x2="265" y2="120" stroke="#374151" stroke-width="1.5" marker-end="url(#ah16)"/><line x1="90" y1="195" x2="90" y2="15" stroke="#374151" stroke-width="1.5" marker-end="url(#ah16)"/><polyline points="20,185 40,155 60,128 80,118 90,115 100,116 120,124 140,132 160,128 180,112 200,88 220,60 250,20" fill="none" stroke="#2563eb" stroke-width="2.5" stroke-linejoin="round"/><circle cx="35" cy="120" r="4" fill="#2563eb"/><circle cx="130" cy="120" r="4" fill="#2563eb"/><circle cx="210" cy="120" r="4" fill="#2563eb"/><circle cx="90" cy="138" r="4" fill="#10b981"/><text x="20" y="114" class="h16">\u22122</text><text x="124" y="114" class="h16">1</text><text x="204" y="114" class="h16">3</text><text x="94" y="152" class="l16">\u22126</text><text x="260" y="134" class="l16">x</text><text x="95" y="12" class="l16">y</text><text x="93" y="116" class="l16">O</text></svg>',
