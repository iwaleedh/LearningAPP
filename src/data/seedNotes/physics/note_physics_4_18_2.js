export const note_physics_4_18_2 = {
  blocks: [
    ...
    },
    {
      ...
      terms: [],
      data: {
        svg: '<svg viewBox="0 0 500 240" xmlns="http://www.w3.org/2000/svg">  <rect x="0" y="0" width="500" height="240" fill="#0f172a" rx="8"/>  <text x="250" y="22" font-family="Arial" font-size="13" font-weight="bold" fill="#1e293b" text-anchor="middle">Coulomb Force: Repulsion vs Attraction</text>  <line x1="250" y1="35" x2="250" y2="175" stroke="#e2e8f0" stroke-width="1" stroke-dasharray="4,4"/>  <circle cx="110" cy="95" r="18" fill="#ef4444" stroke="#b91c1c" stroke-width="1.5"/>  <text x="110" y="101" font-family="Arial" font-size="16" fill="#1e293b" font-weight="bold" text-anchor="middle">+</text>  <circle cx="185" cy="95" r="18" fill="#ef4444" stroke="#b91c1c" stroke-width="1.5"/>  <text x="185" y="101" font-family="Arial" font-size="16" fill="#1e293b" font-weight="bold" text-anchor="middle">+</text>  <line x1="89" y1="95" x2="55" y2="95" stroke="#dc2626" stroke-width="2.5"/>  <polygon points="55,91 43,95 55,99" fill="#dc2626"/>  <line x1="207" y1="95" x2="241" y2="95" stroke="#dc2626" stroke-width="2.5"/>  <polygon points="241,91 253,95 241,99" fill="#dc2626"/>  <text x="148" y="77" font-family="Arial" font-size="11" fill="#dc2626" font-weight="bold" text-anchor="middle">REPULSION</text>  <text x="148" y="125" font-family="Arial" font-size="11" fill="#64748b" text-anchor="middle">Same sign</text>  <circle cx="315" cy="95" r="18" fill="#ef4444" stroke="#b91c1c" stroke-width="1.5"/>  <text x="315" y="101" font-family="Arial" font-size="16" fill="#1e293b" font-weight="bold" text-anchor="middle">+</text>  <circle cx="390" cy="95" r="18" fill="#3b82f6" stroke="#1d4ed8" stroke-width="1.5"/>  <text x="390" y="101" font-family="Arial" font-size="16" fill="#1e293b" font-weight="bold" text-anchor="middle">&#8722;</text>  <line x1="333" y1="95" x2="367" y2="95" stroke="#7c3aed" stroke-width="2.5"/>  <polygon points="367,91 379,95 367,99" fill="#7c3aed"/>  <line x1="372" y1="95" x2="338" y2="95" stroke="#7c3aed" stroke-width="2.5"/>  <polygon points="338,91 326,95 338,99" fill="#7c3aed"/>  <text x="353" y="77" font-family="Arial" font-size="11" fill="#7c3aed" font-weight="bold" text-anchor="middle">ATTRACTION</text>  <text x="353" y="125" font-family="Arial" font-size="11" fill="#64748b" text-anchor="middle">Opposite sign</text>  <rect x="130" y="145" width="240" height="28" fill="#3d1212" rx="6" stroke="#fca5a5" stroke-width="1.5"/>  <text x="250" y="164" font-family="Arial" font-size="14" fill="#b91c1c" font-weight="bold" text-anchor="middle">F = kQ&#8321;Q&#8322; / r&#178;</text>  <text x="250" y="200" font-family="Arial" font-size="11" fill="#475569" text-anchor="middle">Double r &#8594; Force reduces to &#188; (Inverse Square Law)</text>  <text x="250" y="220" font-family="Arial" font-size="11" fill="#64748b" text-anchor="middle">k &#8776; 8.99 &#215; 10&#8313; N m&#178; C&#8315;&#178;</text></svg>',
