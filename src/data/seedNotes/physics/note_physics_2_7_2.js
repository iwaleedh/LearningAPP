export const note_physics_2_7_2 = {
  blocks: [
    ...
    { id: 'enr-tip-potdiv', type: 'callout', data: { style: 'tip', title: 'Exam Tip: Potential Divider', text: 'V_out = Vs × R_bottom / (R_top + R_bottom). R_bottom increases → V_out increases.\n\nNTC at bottom: hot → low R → low V_out.\nNTC at top: hot → low R → high V_out.\n\nAlways state which configuration. Don\'t confuse R_top and R_bottom in the formula.' } },
    {
      ...
      data: {
        style: 'key',
        title: "Drift Velocity vs Signal Speed Paradox",
        text: "Electrons drift ~mm/s (extremely slowly) but the electric field propagates at ~c. The light comes on almost instantly when you flip a switch, not because electrons travel that fast, but because the field change/signal travels at near-light speed while electron motion is a separate effect."
      }
    },
    {
      id: 'callout-tip-2',
      ...
      data: {
        style: 'tip',
        title: "Remember I = nAev_d",
        text: "Current depends on drift velocity, cross-sectional area, and charge carrier density. A larger cross-section (bigger A) can carry more current even at the same drift velocity. Copper has higher charge carrier density (n) than other conductors, so copper wires can carry large currents."
      }
    }
  ],
