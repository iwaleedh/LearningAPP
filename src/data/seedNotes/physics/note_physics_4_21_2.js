export const note_physics_4_21_2 = {
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="70" width="130" height="60" fill="#EF4444" rx="4"/><text x="95" y="107" font-family="Arial" font-size="20" fill="white" text-anchor="middle" font-weight="bold">N</text><path d="M170,100 L248,100 L236,93 M248,100 L236,107" stroke="#374151" stroke-width="2.5" fill="none"/><rect x="260" y="40" width="18" height="120" fill="none" stroke="#D97706" stroke-width="4" rx="2"/><text x="310" y="94" font-family="Arial" font-size="13" fill="#B45309" text-anchor="middle">Induced</text><text x="310" y="112" font-family="Arial" font-size="13" fill="#B45309" text-anchor="middle">N pole</text></svg>',
