export const note_physics_2_12_1 = {
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 480 240" xmlns="http://www.w3.org/2000/svg" style="background:#1e1e2f;border-radius:8px;font-family:sans-serif;"><circle cx="60" cy="80" r="10" fill="#6366f1"/><text x="60" y="108" fill="#a5b4fc" font-size="13" text-anchor="middle">S1</text><circle cx="60" cy="160" r="10" fill="#6366f1"/><text x="60" y="178" fill="#a5b4fc" font-size="13" text-anchor="middle">S2</text><circle cx="340" cy="120" r="8" fill="#facc15"/><text x="340" y="108" fill="#facc15" font-size="13" text-anchor="middle">P</text><line x1="70" y1="80" x2="332" y2="120" stroke="#34d399" stroke-width="2" stroke-dasharray="6,3"/><text x="200" y="88" fill="#34d399" font-size="12" text-anchor="middle">r1</text><line x1="70" y1="160" x2="332" y2="122" stroke="#f87171" stroke-width="2" stroke-dasharray="6,3"/><text x="200" y="156" fill="#f87171" font-size="12" text-anchor="middle">r2</text><text x="370" y="124" fill="#fde68a" font-size="12">|r2−r1|</text><rect x="0" y="195" width="480" height="44" fill="#0f172a" rx="4"/><text x="12" y="211" fill="#86efac" font-size="11">path diff = 0 → in phase → constructive</text><text x="12" y="226" fill="#fca5a5" font-size="11">path diff = λ/2 → antiphase → destructive    path diff = λ → in phase → constructive</text></svg>',
