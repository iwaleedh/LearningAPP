export const note_physics_5_30_3 = {
  blocks: [
    ...
    { id: 'svg-101', type: 'svg', data: { svg: '<svg viewBox="0 0 400 155" xmlns="http://www.w3.org/2000/svg"><rect width="400" height="155" fill="#f8f9fa"/><text x="200" y="18" font-family="sans-serif" font-size="13" font-weight="bold" fill="#212529" text-anchor="middle">Gamma Absorption Experiment Setup</text><rect x="20" y="60" width="45" height="40" rx="4" fill="#fab005" stroke="#e67700" stroke-width="2"/><text x="42" y="82" font-family="sans-serif" font-size="9" fill="#fff" text-anchor="middle">&#947;</text><text x="42" y="95" font-family="sans-serif" font-size="8" fill="#fff" text-anchor="middle">source</text><line x1="65" y1="80" x2="100" y2="80" stroke="#fa5252" stroke-width="1.5" stroke-dasharray="3,2"/><line x1="65" y1="78" x2="100" y2="70" stroke="#fa5252" stroke-width="1" stroke-dasharray="3,2"/><line x1="65" y1="82" x2="100" y2="90" stroke="#fa5252" stroke-width="1" stroke-dasharray="3,2"/><rect x="100" y="62" width="12" height="36" rx="2" fill="#868e96" stroke="#495057" stroke-width="1"/><text x="106" y="58" font-family="sans-serif" font-size="8" fill="#495057" text-anchor="middle">Lead</text><text x="106" y="50" font-family="sans-serif" font-size="8" fill="#495057" text-anchor="middle">(x mm)</text><rect x="125" y="62" width="12" height="36" rx="2" fill="#868e96" stroke="#495057" stroke-width="1"/><rect x="150" y="62" width="12" height="36" rx="2" fill="#868e96" stroke="#495057" stroke-width="1"/><rect x="220" y="55" width="50" height="50" rx="5" fill="#e7f5ff" stroke="#339af0" stroke-width="2"/><text x="245" y="78" font-family="sans-serif" font-size="9" fill="#1864ab" text-anchor="middle">GM</text><text x="245" y="92" font-family="sans-serif" font-size="9" fill="#1864ab" text-anchor="middle">tube</text><line x1="270" y1="80" x2="320" y2="80" stroke="#212529" stroke-width="1.5"/><rect x="320" y="62" width="60" height="36" rx="3" fill="#d3f9d8" stroke="#40c057" stroke-width="1.5"/><text x="350" y="80" font-family="sans-serif" font-size="9" fill="#2b8a3e" text-anchor="middle">Counter</text><text x="200" y="130" font-family="sans-serif" font-size="9" fill="#495057" text-anchor="middle">Add/remove lead plates; record count rate C at each thickness x</text><text x="200" y="145" font-family="sans-serif" font-size="9" fill="#495057" text-anchor="middle">Correct for background: I = C &#8722; C_background</text></svg>', caption: 'Setup: gamma source, lead absorber sheets (measure x), GM tube, counter. Keep source-detector distance constant.' } },
