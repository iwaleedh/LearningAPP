export const note_physics_4_21_3 = {
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 500 240" xmlns="http://www.w3.org/2000/svg"><rect width="500" height="240" fill="#0f172a" rx="6"/><line x1="70" y1="20" x2="70" y2="200" stroke="#374151" stroke-width="2"/><line x1="70" y1="130" x2="470" y2="130" stroke="#374151" stroke-width="2"/><line x1="70" y1="80" x2="470" y2="80" stroke="#e5e7eb" stroke-width="1" stroke-dasharray="5"/><line x1="70" y1="180" x2="470" y2="180" stroke="#e5e7eb" stroke-width="1" stroke-dasharray="5"/><polyline points="70,170 160,55 260,55 380,160" fill="none" stroke="#6366f1" stroke-width="3" stroke-linejoin="round"/><text x="63" y="134" font-family="Arial" font-size="12" fill="#374151" text-anchor="end">0</text><text x="63" y="62" font-family="Arial" font-size="12" fill="#374151" text-anchor="end">+NΦ</text><text x="63" y="184" font-family="Arial" font-size="12" fill="#374151" text-anchor="end">−NΦ</text><text x="474" y="134" font-family="Arial" font-size="12" fill="#374151">t</text><text x="72" y="17" font-family="Arial" font-size="12" fill="#374151">NΦ / Wb turns</text><rect x="76" y="148" width="76" height="35" fill="#3d1212" rx="3"/><text x="114" y="162" font-family="Arial" font-size="10" fill="#dc2626" text-anchor="middle">steep +ve</text><text x="114" y="175" font-family="Arial" font-size="10" fill="#dc2626" text-anchor="middle">gradient → large |ε|</text><rect x="168" y="35" width="80" height="30" fill="#0a2e1a" rx="3"/><text x="208" y="49" font-family="Arial" font-size="10" fill="#15803d" text-anchor="middle">zero gradient</text><text x="208" y="62" font-family="Arial" font-size="10" fill="#15803d" text-anchor="middle">→ ε = 0</text><rect x="295" y="88" width="78" height="30" fill="#78350f" rx="3"/><text x="334" y="102" font-family="Arial" font-size="10" fill="#b45309" text-anchor="middle">−ve gradient</text><text x="334" y="115" font-family="Arial" font-size="10" fill="#b45309" text-anchor="middle">→ +ve ε (Lenz)</text><text x="250" y="228" font-family="Arial" font-size="11" fill="#6b7280" text-anchor="middle">Flux linkage–time graph: gradient = −induced e.m.f.</text></svg>',
