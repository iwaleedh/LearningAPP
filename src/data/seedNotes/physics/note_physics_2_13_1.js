export const note_physics_2_13_1 = {
  ...
  <text x="186" y="115" fill="#facc15" font-size="14">θ₁</text>
  <text x="237" y="218" fill="#34d399" font-size="14">θ₂</text>
  <text x="16" y="95" fill="#f1f5f9" font-size="13">Air  n₁ = 1.0</text>
  <text x="16" y="215" fill="#93c5fd" font-size="13">Glass  n₂ = 1.5</text>
  <text x="358" y="75" fill="#f8fafc" font-size="12" text-anchor="middle">n₁sinθ₁ = n₂sinθ₂</text>
