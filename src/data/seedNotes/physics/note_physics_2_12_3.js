export const note_physics_2_12_3 = {
  blocks: [
    ...
    { id: 'callout-5', type: 'callout', data: { style: 'tip', title: 'Exam Tip: Harmonic Frequencies', text: 'Remember: the nth harmonic has n <strong>antinodes</strong> and <strong>wavelength</strong> λ = 2L/n. <strong>Frequency</strong> fₙ = n × f₁. This means if you double the <strong>frequency</strong> you get the second harmonic — do NOT confuse this with "doubling the number of loops means you have twice as many waves".' }, terms: [] },
    {
      ...
      type: "svg",
      data: {
        svg: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg" style="background:#1e1e2f;border-radius:8px;font-family:sans-serif;"><rect x="50" y="50" width="300" height="100" fill="#1e293b" rx="8" stroke="#38bdf8" stroke-width="2"/><text x="200" y="80" fill="#0f172a" font-size="16" text-anchor="middle">v = sqrt(T / mu)</text><text x="200" y="110" fill="#0f172a" font-size="16" text-anchor="middle">f1 = (1/2L) x sqrt(T/mu)</text><text x="200" y="140" fill="#78350f" font-size="14" text-anchor="middle" font-weight="bold">Wave Speed on Stretched String</text></svg>',
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 500 240" xmlns="http://www.w3.org/2000/svg"><rect width="500" height="240" fill="#0f172a" rx="10"/><text x="250" y="20" fill="#1e293b" font-size="13" text-anchor="middle" font-weight="bold">Harmonics of a Stretched String</text><rect x="65" y="38" width="7" height="150" fill="#64748b" rx="2"/><rect x="428" y="38" width="7" height="150" fill="#64748b" rx="2"/><text x="30" y="64" fill="#7dd3fc" font-size="11" text-anchor="middle" font-weight="bold">n=1</text><text x="30" y="116" fill="#7dd3fc" font-size="11" text-anchor="middle" font-weight="bold">n=2</text><text x="30" y="168" fill="#7dd3fc" font-size="11" text-anchor="middle" font-weight="bold">n=3</text><text x="470" y="64" fill="#94a3b8" font-size="11" text-anchor="middle">f₁</text><text x="470" y="116" fill="#94a3b8" font-size="11" text-anchor="middle">2f₁</text><text x="470" y="168" fill="#94a3b8" font-size="11" text-anchor="middle">3f₁</text><line x1="72" y1="60" x2="428" y2="60" stroke="#1e3a5f" stroke-width="1" stroke-dasharray="4,3"/><line x1="72" y1="112" x2="428" y2="112" stroke="#1e3a5f" stroke-width="1" stroke-dasharray="4,3"/><line x1="72" y1="164" x2="428" y2="164" stroke="#1e3a5f" stroke-width="1" stroke-dasharray="4,3"/><path d="M 72,60 Q 250,33 428,60" fill="none" stroke="#38bdf8" stroke-width="2.5" stroke-linecap="round"/><circle cx="72" cy="60" r="4" fill="#f472b6"/><circle cx="428" cy="60" r="4" fill="#f472b6"/><circle cx="250" cy="33" r="4" fill="#0a4a1a"/><path d="M 72,112 Q 161,85 250,112 Q 339,139 428,112" fill="none" stroke="#38bdf8" stroke-width="2.5" stroke-linecap="round"/><circle cx="72" cy="112" r="4" fill="#f472b6"/><circle cx="250" cy="112" r="4" fill="#f472b6"/><circle cx="428" cy="112" r="4" fill="#f472b6"/><circle cx="161" cy="85" r="4" fill="#0a4a1a"/><circle cx="339" cy="139" r="4" fill="#0a4a1a"/><path d="M 72,164 Q 131,137 191,164 Q 250,191 309,164 Q 369,137 428,164" fill="none" stroke="#38bdf8" stroke-width="2.5" stroke-linecap="round"/><circle cx="72" cy="164" r="4" fill="#f472b6"/><circle cx="191" cy="164" r="4" fill="#f472b6"/><circle cx="309" cy="164" r="4" fill="#f472b6"/><circle cx="428" cy="164" r="4" fill="#f472b6"/><circle cx="131" cy="137" r="4" fill="#0a4a1a"/><circle cx="250" cy="191" r="4" fill="#0a4a1a"/><circle cx="369" cy="137" r="4" fill="#0a4a1a"/><circle cx="150" cy="212" r="4" fill="#f472b6"/><text x="160" y="216" fill="#f472b6" font-size="10">Node</text><circle cx="210" cy="212" r="4" fill="#0a4a1a"/><text x="220" y="216" fill="#0a4a1a" font-size="10">Antinode</text><line x1="72" y1="228" x2="428" y2="228" stroke="#475569" stroke-width="1"/><line x1="72" y1="223" x2="72" y2="233" stroke="#475569" stroke-width="1"/><line x1="428" y1="223" x2="428" y2="233" stroke="#475569" stroke-width="1"/><text x="250" y="238" fill="#94a3b8" font-size="11" text-anchor="middle">String length L</text></svg>',
