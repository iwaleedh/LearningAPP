export const note_physics_4_17_4 = {
  blocks: [
    { id: 'obj-1', type: 'objective', data: { text: "Understand Centripetal Force" } },
    { id: 'head-1', type: 'heading', data: { text: "Centripetal Force", level: 2 } },
    { id: 'para-2', type: 'paragraph', data: { text: "Radians & Angular Displacement Radians A radian (rad) is defined as: The angle subtended at the centre of a circle by an arc equal in length to the radius of" } },
    { id: 'para-3', type: 'paragraph', data: { text: "the circle Radians are used whenever describing the angular displacement of objects in circular motion Angular displacement can be calculated using the equation:" } },
    { id: 'para-4', type: 'paragraph', data: { text: "Where: Δ θ = angular displacement, or angle of rotation (radians) s = length of the arc, or the distance travelled around the circle (m) r = radius of the circle (m)" } },
    { id: 'para-5', type: 'paragraph', data: { text: "Radians are commonly written in terms of π The angle in radians for a complete circle (360) is equal to: Radian Conversions If an angle of 360 = 2 π  radians, then 1 radian in degrees is equal to:" } },
    { id: 'para-6', type: 'paragraph', data: { text: "Use the following equation to convert from degrees to radians: Table of common degrees to radians conversions o o" } },
    { id: 'para-7', type: 'paragraph', data: { text: "Worked Example Convert the following angular displacement into degrees: Answer: Examiner Tips and Tricks" } },
    { id: 'para-8', type: 'paragraph', data: { text: "You will notice your calculator has a degree (Deg) and radians (Rad) mode This is shown by the “D” or “R” highlighted at the top of the screen Remember to make sure it's in the right mode when using trigonometric functions (sin, cos, tan) depending on whether the answer is required in degrees" } },
    { id: 'para-9', type: 'paragraph', data: { text: "Angular Displacement The angular displacement Δ θ is the ratio of: Angular displacement describes the changeinangle, in radians, of a body as it moves in a circle" } },
