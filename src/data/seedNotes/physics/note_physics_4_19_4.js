export const note_physics_4_19_4 = {
  blocks: [
    { id: 'obj-1', type: 'objective', data: { text: "Understand Exponential Discharge in a Capacitor" } },
    { id: 'head-1', type: 'heading', data: { text: "Exponential Discharge in a Capacitor", level: 2 } },
