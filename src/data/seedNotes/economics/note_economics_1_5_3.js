export const note_economics_1_5_3 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 270"><rect width="320" height="270" fill="#0f172a"/><text x="160" y="16" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">Deadweight Welfare Loss — Negative Externality</text><!-- Axes --><line x1="45" y1="240" x2="295" y2="240" stroke="#334155" stroke-width="2"/><line x1="45" y1="240" x2="45" y2="30" stroke="#334155" stroke-width="2"/><text x="300" y="244" font-size="10" fill="#334155">Q</text><text x="33" y="28" font-size="10" fill="#334155">P</text><!-- Demand = MSB --><line x1="65" y1="55" x2="265" y2="215" stroke="#ef4444" stroke-width="2"/><text x="268" y="213" font-size="10" fill="#ef4444">D=MSB</text><!-- MPC (supply) --><line x1="65" y1="215" x2="260" y2="75" stroke="#3b82f6" stroke-width="2"/><text x="262" y="73" font-size="10" fill="#3b82f6">MPC</text><!-- MSC --><line x1="65" y1="175" x2="255" y2="50" stroke="#f59e0b" stroke-width="2.5"/><text x="257" y="48" font-size="10" fill="#f59e0b">MSC</text><!-- Market equilibrium Qm (MPC = D) ~(165,135) --><circle cx="165" cy="135" r="4" fill="#3b82f6"/><!-- Social optimum Q* (MSC = MSB) ~(143,112) --><circle cx="143" cy="112" r="4" fill="#10b981"/><!-- P* dashed --><line x1="45" y1="112" x2="143" y2="112" stroke="#10b981" stroke-width="1" stroke-dasharray="3,3"/><text x="25" y="115" font-size="9" fill="#10b981">P*</text><!-- Pm dashed --><line x1="45" y1="135" x2="165" y2="135" stroke="#94a3b8" stroke-width="1" stroke-dasharray="3,3"/><text x="25" y="138" font-size="9" fill="#3b82f6">Pm</text><!-- Q* vertical --><line x1="143" y1="112" x2="143" y2="240" stroke="#94a3b8" stroke-width="1" stroke-dasharray="3,3"/><text x="136" y="254" font-size="9" fill="#10b981">Q*</text><!-- Qm vertical --><line x1="165" y1="135" x2="165" y2="240" stroke="#94a3b8" stroke-width="1" stroke-dasharray="3,3"/><text x="158" y="254" font-size="9" fill="#3b82f6">Qm</text><!-- DWL triangle shaded --><polygon points="143,112 165,135 143,135" fill="#ef4444" fill-opacity="0.4" stroke="#ef4444" stroke-width="1"/><text x="148" y="132" font-size="9" font-weight="bold" fill="#ef4444">DWL</text><!-- Annotations --><text x="100" y="160" font-size="9" fill="#334155">Overproduction</text><text x="100" y="172" font-size="9" fill="#334155">beyond Q*</text></svg>',
