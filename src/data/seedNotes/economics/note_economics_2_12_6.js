export const note_economics_2_12_6 = {
  pdfPath: '',
  blocks: [
    { id: 'obj-1', type: 'objective', data: { text: 'Explain free-market supply-side policies, including deregulation, privatisation, tax cuts, and labour market reforms.' } },
    { id: 'h-1', type: 'heading', data: { text: 'Free-Market Supply-Side Policies', level: 2 } },
  ...
  recall: {
    ...
    summaryText: 'Free-market supply-side: deregulation, privatisation, tax cuts, welfare reform, trade liberalisation, competition policy. Reduce distortions, boost efficiency.',
    cues: [
      { id: 'cue-1', blockId: 'list-1', prompt: 'How do income tax cuts increase labour supply as a supply-side measure?', answer: 'Lower marginal income tax rates increase the post-tax reward for working — they reduce the opportunity cost of working (the tax wedge between gross and net pay) and lower the replacement ratio, raising the incentive to enter/increase work hours.' },
      { id: 'cue-2', blockId: 'list-1', prompt: 'What is the Laffer curve argument for tax cuts?', answer: 'The Laffer curve suggests that above a certain tax rate, cutting the rate can actually increase total tax revenue because it improves work/investment incentives sufficiently to expand the tax base — a controversial supply-side argument.' },
    ]
  },
  evidence: [], mentions: []
};
