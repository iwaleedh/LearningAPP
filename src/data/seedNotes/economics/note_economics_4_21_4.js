export const note_economics_4_21_4 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 480 380" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><rect width="480" height="380" fill="#f9fafb" rx="8"/><text x="240" y="25" text-anchor="middle" font-size="14" font-weight="bold" fill="#1f2937">Lorenz Curve and Gini Coefficient</text><rect x="60" y="40" width="360" height="280" fill="white" stroke="#d1d5db" stroke-width="1"/><line x1="60" y1="320" x2="420" y2="40" stroke="#9ca3af" stroke-width="1.5" stroke-dasharray="6,4"/><text x="430" y="38" font-size="11" fill="#9ca3af">Line of perfect</text><text x="430" y="51" font-size="11" fill="#9ca3af">equality</text><path d="M60,320 Q160,310 240,265 Q320,220 420,40" stroke="#6366f1" stroke-width="2.5" fill="none"/><text x="240" y="360" text-anchor="middle" font-size="12" fill="#374151">Cumulative % of population (poorest to richest)</text><text x="15" y="185" text-anchor="middle" font-size="12" fill="#374151" transform="rotate(-90,15,185)">Cumulative % of income</text><text x="60" y="335" text-anchor="middle" font-size="11" fill="#6b7280">0%</text><text x="420" y="335" text-anchor="middle" font-size="11" fill="#6b7280">100%</text><text x="48" y="324" text-anchor="end" font-size="11" fill="#6b7280">0%</text><text x="48" y="44" text-anchor="end" font-size="11" fill="#6b7280">100%</text><text x="200" y="230" font-size="12" font-weight="bold" fill="#6366f1">Lorenz Curve</text><text x="155" y="175" font-size="12" fill="#ef4444">A</text><text x="280" y="240" font-size="12" fill="#10b981">B</text><path d="M60,320 Q160,310 240,265 Q320,220 420,40 L60,40 Z" fill="#ef4444" fill-opacity="0.12"/><polygon points="60,320 420,40 60,40" fill="#10b981" fill-opacity="0.12"/><text x="240" y="285" text-anchor="middle" font-size="10" fill="#6366f1">Gini = A / (A + B)</text></svg>',
