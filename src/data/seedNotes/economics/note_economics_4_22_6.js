export const note_economics_4_22_6 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><rect width="480" height="320" fill="#0f172a" rx="8"/><text x="240" y="25" text-anchor="middle" font-size="14" font-weight="bold" fill="#1f2937">The Laffer Curve</text><line x1="60" y1="270" x2="420" y2="270" stroke="#6b7280" stroke-width="2"/><line x1="60" y1="40" x2="60" y2="270" stroke="#6b7280" stroke-width="2"/><text x="240" y="298" text-anchor="middle" font-size="12" fill="#374151">Tax Rate (%)</text><text x="18" y="155" text-anchor="middle" font-size="12" fill="#374151" transform="rotate(-90,18,155)">Tax Revenue</text><path d="M60,270 Q130,60 240,60 Q350,60 420,270" stroke="#3b82f6" stroke-width="2.5" fill="none"/><line x1="240" y1="60" x2="240" y2="270" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="5,4"/><text x="240" y="285" text-anchor="middle" font-size="11" fill="#ef4444">t*</text><text x="50" y="285" text-anchor="end" font-size="11" fill="#6b7280">0%</text><text x="420" y="285" text-anchor="middle" font-size="11" fill="#6b7280">100%</text><text x="240" y="52" text-anchor="middle" font-size="11" fill="#10b981">Revenue max</text><text x="90" y="170" font-size="11" fill="#374151">Raising rate</text><text x="90" y="183" font-size="11" fill="#374151">increases revenue</text><text x="310" y="170" font-size="11" fill="#374151">Raising rate</text><text x="310" y="183" font-size="11" fill="#374151">reduces revenue</text></svg>',
