export const note_economics_1_4_1 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 270"><rect width="360" height="270" fill="#0f172a"/><text x="180" y="18" text-anchor="middle" font-size="13" font-weight="bold" fill="#1e293b">Shortage and Surplus Adjustment</text><!-- Axes --><line x1="40" y1="240" x2="330" y2="240" stroke="#334155" stroke-width="2"/><line x1="40" y1="240" x2="40" y2="30" stroke="#334155" stroke-width="2"/><text x="335" y="244" font-size="11" fill="#334155">Q</text><text x="28" y="28" font-size="11" fill="#334155">P</text><!-- Demand --><line x1="60" y1="60" x2="300" y2="220" stroke="#ef4444" stroke-width="2.5"/><text x="303" y="220" font-size="11" fill="#ef4444">D</text><!-- Supply --><line x1="60" y1="220" x2="300" y2="60" stroke="#3b82f6" stroke-width="2.5"/><text x="303" y="60" font-size="11" fill="#3b82f6">S</text><!-- Equilibrium --><circle cx="180" cy="140" r="4" fill="#10b981"/><line x1="40" y1="140" x2="180" y2="140" stroke="#94a3b8" stroke-width="1" stroke-dasharray="3,3"/><text x="24" y="143" font-size="9" fill="#10b981">P*</text><!-- High price (surplus) --><line x1="40" y1="90" x2="320" y2="90" stroke="#f59e0b" stroke-width="1" stroke-dasharray="4,2"/><!-- Qs at P_high ~260, Qd at P_high ~100 --><text x="24" y="93" font-size="9" fill="#f59e0b">P_h</text><text x="100" y="83" font-size="9" fill="#3b82f6">Qs_h</text><text x="255" y="83" font-size="9" fill="#3b82f6">Qd_h</text><text x="140" y="78" font-size="9" fill="#f59e0b">SURPLUS</text><line x1="105" y1="90" x2="253" y2="90" stroke="#f59e0b" stroke-width="2" marker-end="url(#a1)"/><!-- Low price (shortage) --><line x1="40" y1="190" x2="320" y2="190" stroke="#ef4444" stroke-width="1" stroke-dasharray="4,2"/><text x="24" y="193" font-size="9" fill="#ef4444">P_l</text><text x="90" y="186" font-size="9" fill="#ef4444">Qd_l</text><text x="260" y="186" font-size="9" fill="#ef4444">Qs_l</text><text x="140" y="205" font-size="9" fill="#ef4444">SHORTAGE</text><line x1="255" y1="190" x2="107" y2="190" stroke="#ef4444" stroke-width="2" marker-end="url(#a2)"/><defs><marker id="a1" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L6,3 z" fill="#f59e0b"/></marker><marker id="a2" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L6,3 z" fill="#ef4444"/></marker></defs></svg>',
