export const note_economics_1_4_0 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 260"><rect width="300" height="260" fill="#f8f9fa"/><text x="150" y="18" text-anchor="middle" font-size="13" font-weight="bold" fill="#1e293b">Market Equilibrium</text><!-- Axes --><line x1="50" y1="230" x2="280" y2="230" stroke="#334155" stroke-width="2"/><line x1="50" y1="230" x2="50" y2="30" stroke="#334155" stroke-width="2"/><text x="285" y="234" font-size="11" fill="#334155">Q</text><text x="37" y="28" font-size="11" fill="#334155">P</text><!-- Demand curve --><line x1="70" y1="60" x2="260" y2="210" stroke="#ef4444" stroke-width="2.5"/><text x="263" y="210" font-size="11" fill="#ef4444">D</text><!-- Supply curve --><line x1="70" y1="210" x2="260" y2="60" stroke="#6366f1" stroke-width="2.5"/><text x="263" y="60" font-size="11" fill="#6366f1">S</text><!-- Equilibrium point --><circle cx="165" cy="135" r="5" fill="#10b981"/><text x="172" y="132" font-size="11" fill="#10b981">E</text><!-- Dashed lines to axes --><line x1="50" y1="135" x2="165" y2="135" stroke="#94a3b8" stroke-width="1" stroke-dasharray="4,3"/><line x1="165" y1="135" x2="165" y2="230" stroke="#94a3b8" stroke-width="1" stroke-dasharray="4,3"/><text x="30" y="138" font-size="10" fill="#10b981">P*</text><text x="159" y="245" font-size="10" fill="#10b981">Q*</text></svg>',
