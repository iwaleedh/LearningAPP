export const note_economics_4_19_9 = {
  pdfPath: '',
  blocks: [
    { id: 'obj-1', type: 'objective', data: { text: 'Identify and evaluate the main economic arguments used to justify restricting free trade, including both valid and debatable protectionist cases.' } },
    { id: 'h-1', type: 'heading', data: { text: 'Reasons for Free-Trade Restrictions', level: 2 } },
    { id: 'h-2', type: 'heading', data: { text: 'Commonly Argued Cases', level: 2 } },
  ...
  recall: {
    ...
    summaryText: 'Protectionist arguments: infant industry (learning-by-doing), anti-dumping, strategic industries (security), employment defence, countervailing duties, optimal tariff, fiscal revenue. Best cases: anti-dumping + infant industry. Employment defence is weakest economically.',
    cues: [
      { id: 'cue-1', blockId: 'tbl-reasons', prompt: 'Evaluate the infant industry argument for protectionism.', answer: 'Argument: new industries need temporary protection to develop economies of scale and learning-by-doing before competing internationally. Valid in theory — Mill and List both recognised the case. Evidence: Japan, South Korea used selective protection successfully. Limitations: protection tends to become permanent (political pressure); industries may never become competitive; WTO rules restrict duration; domestic consumers pay higher prices throughout. Best case: time-limited, conditioned on export performance benchmarks.' },
    ]
  },
  evidence: [], mentions: []
};
