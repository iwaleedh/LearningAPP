export const note_economics_1_4_2 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 260"><rect width="300" height="260" fill="#0f172a"/><text x="150" y="18" text-anchor="middle" font-size="13" font-weight="bold" fill="#1e293b">Consumer and Producer Surplus</text><!-- Axes --><line x1="50" y1="230" x2="275" y2="230" stroke="#334155" stroke-width="2"/><line x1="50" y1="230" x2="50" y2="30" stroke="#334155" stroke-width="2"/><text x="280" y="234" font-size="11" fill="#334155">Q</text><text x="38" y="28" font-size="11" fill="#334155">P</text><!-- Demand line: from (50,50) to (260,220) --><line x1="60" y1="55" x2="255" y2="210" stroke="#ef4444" stroke-width="2.5"/><text x="258" y="210" font-size="11" fill="#ef4444">D</text><!-- Supply line: from (60,210) to (255,55) --><line x1="60" y1="210" x2="255" y2="55" stroke="#3b82f6" stroke-width="2.5"/><text x="258" y="55" font-size="11" fill="#3b82f6">S</text><!-- Equilibrium at ~(157, 132) --><circle cx="157" cy="132" r="4" fill="#10b981"/><!-- Equilibrium price line --><line x1="50" y1="132" x2="157" y2="132" stroke="#10b981" stroke-width="1.5" stroke-dasharray="4,3"/><text x="25" y="135" font-size="10" fill="#10b981">P*</text><line x1="157" y1="132" x2="157" y2="230" stroke="#10b981" stroke-width="1.5" stroke-dasharray="4,3"/><text x="150" y="245" font-size="10" fill="#10b981">Q*</text><!-- CS triangle shading (approximate polygon) --><polygon points="50,132 157,132 60,55" fill="#ef4444" fill-opacity="0.2" stroke="none"/><text x="78" y="110" font-size="11" fill="#ef4444">CS</text><!-- PS triangle shading --><polygon points="50,132 157,132 60,210" fill="#3b82f6" fill-opacity="0.2" stroke="none"/><text x="78" y="168" font-size="11" fill="#3b82f6">PS</text></svg>',
