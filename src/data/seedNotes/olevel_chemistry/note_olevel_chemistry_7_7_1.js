export const note_olevel_chemistry_7_7_1 = {
  ...
  <!-- Acid liquid -->
  <path d="M 62 120 Q 80 125 100 120 T 138 120 L 138 160 A 8 8 0 0 1 130 168 L 70 168 A 8 8 0 0 1 62 160 Z" fill="#fee2e2" />
  ...
  <text x="85" y="144" font-family="var(--font-sans)" font-size="10" fill="#fff" text-anchor="middle">H⁺</text>
  <circle cx="115" cy="150" r="10" fill="#f87171" />
  <text x="115" y="154" font-family="var(--font-sans)" font-size="10" fill="#fff" text-anchor="middle">Cl⁻</text>
  ...
  <!-- Alkali liquid -->
  <path d="M 262 120 Q 280 125 300 120 T 338 120 L 338 160 A 8 8 0 0 1 330 168 L 270 168 A 8 8 0 0 1 262 160 Z" fill="#e0e7ff" />
  ...
  <text x="285" y="144" font-family="var(--font-sans)" font-size="10" fill="#fff" text-anchor="middle">OH⁻</text>
  <circle cx="315" cy="150" r="10" fill="#60a5fa" />
  <text x="315" y="154" font-family="var(--font-sans)" font-size="10" fill="#fff" text-anchor="middle">Na⁺</text>
  ...
  <rect x="90" y="20" width="320" height="30" rx="15" fill="#dcfce7" stroke="#22c55e" stroke-width="2"/>
