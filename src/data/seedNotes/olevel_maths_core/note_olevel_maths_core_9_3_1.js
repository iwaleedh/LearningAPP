export const note_olevel_maths_core_9_3_1 = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: 'svg',
      data: {
        svg: '<svg viewBox="0 0 310 230" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><text x="155" y="14" text-anchor="middle" font-size="10" font-weight="bold" fill="#333">Favourite Sports (n = 30)</text><path d="M 155 115 L 155 30 A 85 85 0 0 1 234 119 Z" fill="#3b82f6" stroke="white" stroke-width="1.5"/><path d="M 155 115 L 234 119 A 85 85 0 0 1 82 153 Z" fill="#8B5CF6" stroke="white" stroke-width="1.5"/><path d="M 155 115 L 82 153 A 85 85 0 0 1 87 53 Z" fill="#06B6D4" stroke="white" stroke-width="1.5"/><path d="M 155 115 L 87 53 A 85 85 0 0 1 155 30 Z" fill="#10B981" stroke="white" stroke-width="1.5"/><text x="198" y="68" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">Cricket</text><text x="198" y="79" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">96°</text><text x="172" y="153" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">Football</text><text x="172" y="164" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">144°</text><text x="94" y="123" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">Tennis</text><text x="94" y="134" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">72°</text><text x="122" y="63" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">Swim</text><text x="122" y="74" text-anchor="middle" font-size="9" fill="#1e293b" font-weight="bold">48°</text><rect x="20" y="185" width="12" height="10" fill="#3b82f6"/><text x="36" y="194" font-size="8" fill="#333">Cricket (8)</text><rect x="90" y="185" width="12" height="10" fill="#8B5CF6"/><text x="106" y="194" font-size="8" fill="#333">Football (12)</text><rect x="175" y="185" width="12" height="10" fill="#06B6D4"/><text x="191" y="194" font-size="8" fill="#333">Tennis (6)</text><rect x="240" y="185" width="12" height="10" fill="#065f46"/><text x="256" y="194" font-size="8" fill="#333">Swim (4)</text></svg>',
