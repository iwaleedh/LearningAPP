export const note_olevel_maths_core_8_2_0 = {
  ...
  <!-- Background -->
  <rect x="0" y="0" width="370" height="310" fill="#f8f9ff" rx="8"/>
  ...
  <!-- Header labels: Die 2 -->
  <text x="205" y="14" text-anchor="middle" fill="white" font-weight="bold" font-size="11">Die 2 →</text>
  <text x="96"  y="36" text-anchor="middle" fill="white" font-weight="bold">1</text>
  <text x="150" y="36" text-anchor="middle" fill="white" font-weight="bold">2</text>
  <text x="204" y="36" text-anchor="middle" fill="white" font-weight="bold">3</text>
  <text x="258" y="36" text-anchor="middle" fill="white" font-weight="bold">4</text>
  <text x="312" y="36" text-anchor="middle" fill="white" font-weight="bold">5</text>
  <text x="366" y="36" text-anchor="middle" fill="white" font-weight="bold">6</text>

  <!-- Side labels: Die 1 -->
  <text x="20" y="68"  text-anchor="middle" fill="white" font-weight="bold">1</text>
  <text x="20" y="112" text-anchor="middle" fill="white" font-weight="bold">2</text>
  <text x="20" y="156" text-anchor="middle" fill="white" font-weight="bold">3</text>
  <text x="20" y="200" text-anchor="middle" fill="white" font-weight="bold">4</text>
  <text x="20" y="244" text-anchor="middle" fill="white" font-weight="bold">5</text>
  <text x="20" y="288" text-anchor="middle" fill="white" font-weight="bold">6</text>
  <text x="20" y="25"  text-anchor="middle" fill="white" font-size="10">↓</text>
  <text x="8"  y="175" text-anchor="middle" fill="white" font-size="10" writing-mode="tb">Die 1</text>

  <!-- Grid cells: rows=Die1(1-6), cols=Die2(1-6). Highlight sum=7 in amber -->
  <!-- Row 1 -->
  <rect x="42" y="45" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="96" y="45" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="150" y="45" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="204" y="45" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="258" y="45" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="312" y="45" width="54" height="42" fill="#fef3c7" stroke="#e5e7eb" stroke-width="1"/>
  ...
  <!-- Row 2 -->
  <rect x="42" y="87" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="96" y="87" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="150" y="87" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="204" y="87" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="258" y="87" width="54" height="42" fill="#fef3c7" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="312" y="87" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  ...
  <!-- Row 3 -->
  <rect x="42" y="129" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="96" y="129" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="150" y="129" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="204" y="129" width="54" height="42" fill="#fef3c7" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="258" y="129" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="312" y="129" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  ...
  <!-- Row 4 -->
  <rect x="42" y="171" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="96" y="171" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="150" y="171" width="54" height="42" fill="#fef3c7" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="204" y="171" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="258" y="171" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="312" y="171" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  ...
  <!-- Row 5 -->
  <rect x="42" y="213" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="96" y="213" width="54" height="42" fill="#fef3c7" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="150" y="213" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="204" y="213" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="258" y="213" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="312" y="213" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  ...
  <!-- Row 6 -->
  <rect x="42" y="255" width="54" height="42" fill="#fef3c7" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="96" y="255" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="150" y="255" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="204" y="255" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="258" y="255" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
  <rect x="312" y="255" width="54" height="42" fill="white" stroke="#e5e7eb" stroke-width="1"/>
